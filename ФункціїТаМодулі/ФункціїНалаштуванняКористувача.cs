...
Збереження налаштувань періодів для журналів і звітів
...
static class ФункціїНалаштуванняКористувача
{
    ...
    static void ЗаповнитиВідбір(Системні.НалаштуванняКористувача_ПеріодиЖурналів_TablePart Налаштування_TablePart, string НазваЖурналу)
    {
        Налаштування_TablePart.QuerySelect.Where.AddRange([
            new(Системні.НалаштуванняКористувача_ПеріодиЖурналів_TablePart.Користувач, Comparison.EQ, Program.Користувач.UniqueID.UGuid), //Відбір по користувачу
