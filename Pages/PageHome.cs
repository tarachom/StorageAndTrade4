...
public class TreeNode<T> : RowTablePart
{
...
class PageHome : Form
{
    ...
    {
        /*
        Номенклатура_Папки_SelectHierarchical Номенклатура_Папки_Select = new();
        ...
        Dictionary<string, TreeIter> nodeDictionary = [];
        ...
        while (Номенклатура_Папки_Select.MoveNext())
        {
            ...
            if (current != null)
            {
                ...
                Номенклатура_Папки_Записи Record = new()
                {
