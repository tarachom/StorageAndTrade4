...
{
    public ЗакриттяЗамовленняПостачальнику_Object Елемент { get; init; } = new();
    ...
    DropDownControl ПричинаЗакриттяЗамовлення = DropDownControl.New();
    ...
    partial void Initialize()
    {
        ...
        ПричинаЗакриттяЗамовлення.Fill(ПсевдонімиПерелічення.ПричиниЗакриттяЗамовленняПостачальнику_Dict());
        ...
        //Підстава:
        Підстава.BoundConfType = "Документи.ЗакриттяЗамовленняПостачальнику.Підстава";
    }
    ...
    public override async Task AssignValue()
    {
        ...
        ПричинаЗакриттяЗамовлення.Value = Елемент.ПричинаЗакриттяЗамовлення.ToString();
    ...
    protected override void GetValue()
    {
        ...
        Елемент.ПричинаЗакриттяЗамовлення = ПсевдонімиПерелічення.ПричиниЗакриттяЗамовленняПостачальнику_FindByName(ПричинаЗакриттяЗамовлення.Value);
