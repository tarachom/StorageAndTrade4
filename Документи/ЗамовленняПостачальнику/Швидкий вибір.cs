...
using ТабличнийСписок = GeneratedCode.Документи.ТабличніСписки.ЗамовленняПостачальнику_Записи;
using Функції = StorageAndTrade.ЗамовленняПостачальнику_Функції;

namespace StorageAndTrade;

[GObject.Subclass<DocumentFormJournalSmall>("SmallList_ePYxMv7uxkOYfnJGJAs6QQ")]
public partial class ЗамовленняПостачальнику_ШвидкийВибір : DocumentFormJournalSmall
{
    partial void Initialize()
    {
        TypeName = ЗамовленняПостачальнику_Const.POINTER;
        KeyForSetting = ".Small";
        ТабличнийСписок.AddColumn(this);
        SetPagesSettings(50);
    }

    public static ЗамовленняПостачальнику_ШвидкийВибір New()
    {
        ЗамовленняПостачальнику_ШвидкийВибір list = NewWithProperties([]);
    ...
    {
        foreach (var uid in uniqueID)
            CommonForms_DocumentMovementThroughRegisters.Create(new ЗамовленняПостачальнику_Pointer(uid));
    }
