...
/*
        РеалізаціяТоварівТаПослуг_ТабличнаЧастина_Проводки.cs
        Таблична Частина
*/
...
[GObject.Subclass<DocumentFormTablePart>("TablePart_OoeeAV8wEnu8OMEHr0eQ")]
partial class РеалізаціяТоварівТаПослуг_ТабличнаЧастина_Проводки : DocumentFormTablePart
{
    #region Data

    [GObject.Subclass<GObject.Object>("ItemRow_S7efASfyG3asVmarAMt5VQ")]
    ...
    public РеалізаціяТоварівТаПослуг_Object? ЕлементВласник { get; set; }
    public РеалізаціяТоварівТаПослуг_Елемент? ЕлементВласникФорма { get; set; }
    ...
    public static РеалізаціяТоварівТаПослуг_ТабличнаЧастина_Проводки New()
    {
        РеалізаціяТоварівТаПослуг_ТабличнаЧастина_Проводки tablePart = NewWithProperties([]);
    ...
    protected override void Columns()
    {
        ...
        //Аналітика1, Аналітика2, Аналітика3
        {
            ...
            factory.OnSetup += (_, args) =>
            {
                ...
                cell.Аналітика1.BoundConfType = "Документи.РеалізаціяТоварівТаПослуг.Проводки.Аналітика1";
                cell.Аналітика2.BoundConfType = "Документи.РеалізаціяТоварівТаПослуг.Проводки.Аналітика2";
                cell.Аналітика3.BoundConfType = "Документи.РеалізаціяТоварівТаПослуг.Проводки.Аналітика3";
        ...
        //КорАналітика1, КорАналітика2, КорАналітика3
        {
            ...
            factory.OnSetup += (_, args) =>
            {
                ...
                cell.Аналітика1.BoundConfType = "Документи.РеалізаціяТоварівТаПослуг.Проводки.КорАналітика1";
                cell.Аналітика2.BoundConfType = "Документи.РеалізаціяТоварівТаПослуг.Проводки.КорАналітика2";
                cell.Аналітика3.BoundConfType = "Документи.РеалізаціяТоварівТаПослуг.Проводки.КорАналітика3";
    ...
    public override async Task LoadRecords()
    {
        ...
        {
            ЕлементВласник.Проводки_TablePart.FillJoin([РеалізаціяТоварівТаПослуг_Проводки_TablePart.НомерРядка,]);
