...
/*
        ВведенняЗалишків_ТабличнаЧастина_Проводки.cs
        Таблична Частина
*/
...
[GObject.Subclass<DocumentFormTablePart>("TablePart_V46eAaVfa3PW0fArBwYQ")]
partial class ВведенняЗалишків_ТабличнаЧастина_Проводки : DocumentFormTablePart
{
    #region Data

    [GObject.Subclass<GObject.Object>("ItemRow_Z7ifAercDXOOMFkQzL01zQ")]
    ...
    public ВведенняЗалишків_Елемент? ЕлементВласникФорма { get; set; }
    ...
    public static ВведенняЗалишків_ТабличнаЧастина_Проводки New()
    {
        ВведенняЗалишків_ТабличнаЧастина_Проводки tablePart = NewWithProperties([]);
    ...
    protected override void Columns()
    {
        ...
        //Аналітика1, Аналітика2, Аналітика3
        {
            ...
            factory.OnSetup += (_, args) =>
            {
                ...
                cell.Аналітика1.BoundConfType = "Документи.ВведенняЗалишків.Проводки.Аналітика1";
                cell.Аналітика2.BoundConfType = "Документи.ВведенняЗалишків.Проводки.Аналітика2";
                cell.Аналітика3.BoundConfType = "Документи.ВведенняЗалишків.Проводки.Аналітика3";
        ...
        //КорАналітика1, КорАналітика2, КорАналітика3
        {
            ...
            factory.OnSetup += (_, args) =>
            {
                ...
                cell.Аналітика1.BoundConfType = "Документи.ВведенняЗалишків.Проводки.КорАналітика1";
                cell.Аналітика2.BoundConfType = "Документи.ВведенняЗалишків.Проводки.КорАналітика2";
                cell.Аналітика3.BoundConfType = "Документи.ВведенняЗалишків.Проводки.КорАналітика3";
    ...
    public override async Task LoadRecords()
    {
        ...
        {
            ЕлементВласник.Проводки_TablePart.FillJoin([ВведенняЗалишків_Проводки_TablePart.НомерРядка,]);
