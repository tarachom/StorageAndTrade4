...
{
    public static async Task<bool> Spend(ВведенняЗалишків_Object ДокументОбєкт)
    {
        try
        {
            #region Підготовка
    ...
    public static async Task Clear(ВведенняЗалишків_Object ДокументОбєкт)
    {
        #region Бух
