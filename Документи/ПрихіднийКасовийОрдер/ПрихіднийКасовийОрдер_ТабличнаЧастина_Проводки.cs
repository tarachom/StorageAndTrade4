...
/*
        ПрихіднийКасовийОрдер_ТабличнаЧастина_Проводки.cs
        Таблична Частина
*/
...
[GObject.Subclass<DocumentFormTablePart>("TablePart_e5GeAQtHn3WveUObFlQ0A")]
partial class ПрихіднийКасовийОрдер_ТабличнаЧастина_Проводки : DocumentFormTablePart
{
    #region Data

    [GObject.Subclass<GObject.Object>("ItemRow_QLifAaLmdnWgrnucX8pgZA")]
    ...
    public ПрихіднийКасовийОрдер_Object? ЕлементВласник { get; set; }
    public ПрихіднийКасовийОрдер_Елемент? ЕлементВласникФорма { get; set; }
    ...
    public static ПрихіднийКасовийОрдер_ТабличнаЧастина_Проводки New()
    {
        ПрихіднийКасовийОрдер_ТабличнаЧастина_Проводки tablePart = NewWithProperties([]);
    ...
    protected override void Columns()
    {
        ...
        //Аналітика1, Аналітика2, Аналітика3
        {
            ...
            factory.OnSetup += (_, args) =>
            {
                ...
                cell.Аналітика1.BoundConfType = "Документи.ПрихіднийКасовийОрдер.Проводки.Аналітика1";
                cell.Аналітика2.BoundConfType = "Документи.ПрихіднийКасовийОрдер.Проводки.Аналітика2";
                cell.Аналітика3.BoundConfType = "Документи.ПрихіднийКасовийОрдер.Проводки.Аналітика3";
        ...
        //КорАналітика1, КорАналітика2, КорАналітика3
        {
            ...
            factory.OnSetup += (_, args) =>
            {
                ...
                cell.Аналітика1.BoundConfType = "Документи.ПрихіднийКасовийОрдер.Проводки.КорАналітика1";
                cell.Аналітика2.BoundConfType = "Документи.ПрихіднийКасовийОрдер.Проводки.КорАналітика2";
                cell.Аналітика3.BoundConfType = "Документи.ПрихіднийКасовийОрдер.Проводки.КорАналітика3";
    ...
    public override async Task LoadRecords()
    {
        ...
        {
            ЕлементВласник.Проводки_TablePart.FillJoin([ПрихіднийКасовийОрдер_Проводки_TablePart.НомерРядка,]);
