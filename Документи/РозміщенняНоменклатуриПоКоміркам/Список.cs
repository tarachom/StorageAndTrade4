...
[GObject.Subclass<DocumentFormJournalFull>("List_kkouCfAJMUmLE0KJrfG7Yw")]
public partial class РозміщенняНоменклатуриПоКоміркам_Список : DocumentFormJournalFull
{
    ...
    public static РозміщенняНоменклатуриПоКоміркам_Список New()
    {
        РозміщенняНоменклатуриПоКоміркам_Список list = NewWithProperties([]);
