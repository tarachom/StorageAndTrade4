...
[GObject.Subclass<DocumentFormTablePart>("TablePart_kj9LYCD0yRHkEZVQtrDA")]
partial class РозміщенняНоменклатуриПоКоміркам_ТабличнаЧастина_Товари : DocumentFormTablePart
{
    ...
    public static РозміщенняНоменклатуриПоКоміркам_ТабличнаЧастина_Товари New()
    {
        РозміщенняНоменклатуриПоКоміркам_ТабличнаЧастина_Товари tablePart = NewWithProperties([]);
