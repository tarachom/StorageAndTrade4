...
/*
        АвансовийЗвіт_ТабличнаЧастина_Проводки.cs
        Таблична Частина
*/
...
[GObject.Subclass<DocumentFormTablePart>("TablePart_DJKeAfBmbn6zKQtiJsccbw")]
partial class АвансовийЗвіт_ТабличнаЧастина_Проводки : DocumentFormTablePart
{
    #region Data

    [GObject.Subclass<GObject.Object>("ItemRow_frifATz1c3uMYB53ePq3Aw")]
   public partial class ItemRow : IRowSubclassTablePart
    ...
    public АвансовийЗвіт_Елемент? ЕлементВласникФорма { get; set; }
    ...
    public static АвансовийЗвіт_ТабличнаЧастина_Проводки New()
    {
        АвансовийЗвіт_ТабличнаЧастина_Проводки tablePart = NewWithProperties([]);
    ...
    protected override void Columns()
    {
        ...
        //Аналітика1, Аналітика2, Аналітика3
        {
            ...
            factory.OnSetup += (_, args) =>
            {
                ...
                cell.Аналітика1.BoundConfType = "Документи.АвансовийЗвіт.Проводки.Аналітика1";
                cell.Аналітика2.BoundConfType = "Документи.АвансовийЗвіт.Проводки.Аналітика2";
                cell.Аналітика3.BoundConfType = "Документи.АвансовийЗвіт.Проводки.Аналітика3";
        ...
        //КорАналітика1, КорАналітика2, КорАналітика3
        {
            ...
            factory.OnSetup += (_, args) =>
            {
                ...
                cell.Аналітика1.BoundConfType = "Документи.АвансовийЗвіт.Проводки.КорАналітика1";
                cell.Аналітика2.BoundConfType = "Документи.АвансовийЗвіт.Проводки.КорАналітика2";
                cell.Аналітика3.BoundConfType = "Документи.АвансовийЗвіт.Проводки.КорАналітика3";
    ...
    public override async Task LoadRecords()
    {
        ...
        {
            ЕлементВласник.Проводки_TablePart.FillJoin([АвансовийЗвіт_Проводки_TablePart.НомерРядка,]);
