...
[GObject.Subclass<DocumentFormJournalFull>("List_K2f4p4CSyUSbND94o0FLbQ")]
public partial class ВстановленняЦінНоменклатури_Список : DocumentFormJournalFull
{
    ...
    public static ВстановленняЦінНоменклатури_Список New()
    {
        ВстановленняЦінНоменклатури_Список list = NewWithProperties([]);
