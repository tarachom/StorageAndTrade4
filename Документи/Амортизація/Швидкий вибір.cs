...
using ТабличнийСписок = GeneratedCode.Документи.ТабличніСписки.Амортизація_Записи;
using Функції = StorageAndTrade.Амортизація_Функції;

namespace StorageAndTrade;

[GObject.Subclass<DocumentFormJournalSmall>("SmallList_yE1m9fmzG0ih58iIj0joaA")]
public partial class Амортизація_ШвидкийВибір : DocumentFormJournalSmall
{
    partial void Initialize()
    {
        TypeName = Амортизація_Const.POINTER;
        KeyForSetting = ".Small";
        ТабличнийСписок.AddColumn(this);
        SetPagesSettings(50);
    }

    public static Амортизація_ШвидкийВибір New()
    {
        Амортизація_ШвидкийВибір list = NewWithProperties([]);
    ...
    {
        foreach (var uid in uniqueID)
            CommonForms_DocumentMovementThroughRegisters.Create(new Амортизація_Pointer(uid));
    }
