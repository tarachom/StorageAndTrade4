...
/*     
        РахунокФактура_PointerTablePartCell.cs
...
[GObject.Subclass<PointerTablePartCell>("PointerTablePartCell_ISBQg0XdaEqN3V7T0zZ59g")]
public partial class РахунокФактура_PointerTablePartCell : PointerTablePartCell
{
    ...
    {
        Pointer = new РахунокФактура_Pointer(p ?? new UniqueID());
