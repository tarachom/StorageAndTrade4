...
partial class ЗакриттяРахункуФактури_Елемент : DocumentFormElement
{
    ...
    DropDownControl ПричинаЗакриттяРахунку = DropDownControl.New();
    ...
    partial void Initialize()
    {
        ...
        ПричинаЗакриттяРахунку.Fill(ПсевдонімиПерелічення.ПричиниЗакриттяРахункуФактури_Dict());
    ...
    public override async Task AssignValue()
    {
        ...
        ПричинаЗакриттяРахунку.Value = Елемент.ПричинаЗакриттяРахунку.ToString();
    ...
    protected override void GetValue()
    {
        ...
        Елемент.ПричинаЗакриттяРахунку = ПсевдонімиПерелічення.ПричиниЗакриттяРахункуФактури_FindByName(ПричинаЗакриттяРахунку.Value);
