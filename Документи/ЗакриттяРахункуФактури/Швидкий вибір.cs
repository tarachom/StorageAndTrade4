...
using ТабличнийСписок = GeneratedCode.Документи.ТабличніСписки.ЗакриттяРахункуФактури_Записи;
using Функції = StorageAndTrade.ЗакриттяРахункуФактури_Функції;

namespace StorageAndTrade;

[GObject.Subclass<DocumentFormJournalSmall>("SmallList_3wTwT4n4xEG9xsA5n61xAQ")]
public partial class ЗакриттяРахункуФактури_ШвидкийВибір : DocumentFormJournalSmall
{
    ...
    public static ЗакриттяРахункуФактури_ШвидкийВибір New()
    {
        ЗакриттяРахункуФактури_ШвидкийВибір list = NewWithProperties([]);
    ...
    {
        foreach (var uid in uniqueID)
            CommonForms_DocumentMovementThroughRegisters.Create(new ЗакриттяРахункуФактури_Pointer(uid));
    }
