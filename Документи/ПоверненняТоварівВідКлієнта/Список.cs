...
[GObject.Subclass<DocumentFormJournalFull>("List_EUoYHcAUPkm8rHLUwRMVDg")]
public partial class ПоверненняТоварівВідКлієнта_Список : DocumentFormJournalFull
{
    ...
    public static ПоверненняТоварівВідКлієнта_Список New()
    {
        ПоверненняТоварівВідКлієнта_Список list = NewWithProperties([]);
