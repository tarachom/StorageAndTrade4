...
[GObject.Subclass<DocumentFormJournalSmall>("SmallList_szmAfOUQS0qF4i8lGMijRQ")]
public partial class ПоверненняТоварівВідКлієнта_ШвидкийВибір : DocumentFormJournalSmall
{
    ...
    public static ПоверненняТоварівВідКлієнта_ШвидкийВибір New()
    {
        ПоверненняТоварівВідКлієнта_ШвидкийВибір list = NewWithProperties([]);
