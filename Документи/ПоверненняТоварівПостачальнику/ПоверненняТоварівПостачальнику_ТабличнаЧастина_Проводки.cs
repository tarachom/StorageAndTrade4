...
partial class ПоверненняТоварівПостачальнику_ТабличнаЧастина_Проводки : DocumentFormTablePart
{
    ...
    [GObject.Subclass<GObject.Object>("ItemRow_UrifASSzgXylr1vzvenQrw")]
    ...
    public ПоверненняТоварівПостачальнику_Елемент? ЕлементВласникФорма { get; set; }
    ...
    protected override void Columns()
    {
        ...
        //КорАналітика1, КорАналітика2, КорАналітика3
        {
            ...
            factory.OnSetup += (_, args) =>
            {
                ...
                cell.Аналітика1.BoundConfType = "Документи.ПоверненняТоварівПостачальнику.Проводки.КорАналітика1";
                cell.Аналітика2.BoundConfType = "Документи.ПоверненняТоварівПостачальнику.Проводки.КорАналітика2";
                cell.Аналітика3.BoundConfType = "Документи.ПоверненняТоварівПостачальнику.Проводки.КорАналітика3";
