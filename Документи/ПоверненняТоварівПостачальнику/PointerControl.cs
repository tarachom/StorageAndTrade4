...
[GObject.Subclass<PointerControl>("PointerControl_Md2j8nkSckadMBgtNdwVIw")]
public partial class ПоверненняТоварівПостачальнику_PointerControl : PointerControl
{
    ...
    public static ПоверненняТоварівПостачальнику_PointerControl New() => NewWithProperties([]);
    ...
    protected override async void OpenSelect(Button button, EventArgs args)
    {
        ...
        ПоверненняТоварівПостачальнику_ШвидкийВибір page = ПоверненняТоварівПостачальнику_ШвидкийВибір.New();
