...
/*
        АктВиконанихРобіт_ТабличнаЧастина_Проводки.cs
        Таблична Частина
*/
...
[GObject.Subclass<DocumentFormTablePart>("TablePart_p4eeAYO5kHWLW7BUerPWQ")]
partial class АктВиконанихРобіт_ТабличнаЧастина_Проводки : DocumentFormTablePart
{
    #region Data

    [GObject.Subclass<GObject.Object>("ItemRow_YbifAdy2yXGxUAEdW0oO4w")]
    ...
    public АктВиконанихРобіт_Елемент? ЕлементВласникФорма { get; set; }
    ...
    public static АктВиконанихРобіт_ТабличнаЧастина_Проводки New()
    {
        АктВиконанихРобіт_ТабличнаЧастина_Проводки tablePart = NewWithProperties([]);
    ...
    protected override void Columns()
    {
        ...
        //Аналітика1, Аналітика2, Аналітика3
        {
            ...
            factory.OnSetup += (_, args) =>
            {
                ...
                cell.Аналітика1.BoundConfType = "Документи.АктВиконанихРобіт.Проводки.Аналітика1";
                cell.Аналітика2.BoundConfType = "Документи.АктВиконанихРобіт.Проводки.Аналітика2";
                cell.Аналітика3.BoundConfType = "Документи.АктВиконанихРобіт.Проводки.Аналітика3";
        ...
        //КорАналітика1, КорАналітика2, КорАналітика3
        {
            ...
            factory.OnSetup += (_, args) =>
            {
                ...
                cell.Аналітика1.BoundConfType = "Документи.АктВиконанихРобіт.Проводки.КорАналітика1";
                cell.Аналітика2.BoundConfType = "Документи.АктВиконанихРобіт.Проводки.КорАналітика2";
                cell.Аналітика3.BoundConfType = "Документи.АктВиконанихРобіт.Проводки.КорАналітика3";
    ...
    public override async Task LoadRecords()
    {
        ...
        {
            ЕлементВласник.Проводки_TablePart.FillJoin([АктВиконанихРобіт_Проводки_TablePart.НомерРядка,]);
