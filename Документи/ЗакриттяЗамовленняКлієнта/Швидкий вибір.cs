...
[GObject.Subclass<DocumentFormJournalSmall>("SmallList_kymYmOmws0CDyf0ZEpVdGw")]
public partial class ЗакриттяЗамовленняКлієнта_ШвидкийВибір : DocumentFormJournalSmall
{
    ...
    public static ЗакриттяЗамовленняКлієнта_ШвидкийВибір New()
    {
        ЗакриттяЗамовленняКлієнта_ШвидкийВибір list = NewWithProperties([]);
