...
partial class ЗакриттяЗамовленняКлієнта_Елемент : DocumentFormElement
{
    ...
    partial void Initialize()
    {
        ...
        ПричинаЗакриттяЗамовлення.Fill(ПсевдонімиПерелічення.ПричиниЗакриттяЗамовленняКлієнта_Dict());
    ...
    protected override void GetValue()
    {
        ...
        Елемент.ПричинаЗакриттяЗамовлення = ПсевдонімиПерелічення.ПричиниЗакриттяЗамовленняКлієнта_FindByName(ПричинаЗакриттяЗамовлення.Value);
