...
[GObject.Subclass<DocumentFormElement>("Element_fzMXpWXdkuNaotHie3ynw")]
partial class ПереміщенняТоварівНаСкладі_Елемент : DocumentFormElement
{
    public ПереміщенняТоварівНаСкладі_Object Елемент { get; init; } = new();
    ...
    ПереміщенняТоварівНаСкладі_ТабличнаЧастина_Товари Товари = ПереміщенняТоварівНаСкладі_ТабличнаЧастина_Товари.New();
    ...
    partial void Initialize()
    {
        ...
        //Підстава:
        Підстава.BoundConfType = "Документи.ПереміщенняТоварівНаСкладі.Підстава";
    ...
    public static ПереміщенняТоварівНаСкладі_Елемент New()
    {
        ПереміщенняТоварівНаСкладі_Елемент element = NewWithProperties([]);
    ...
    {
        return $"\n {Склад.Pointer.Назва} {Автор.Pointer.Назва} {Організація.Pointer.Назва} {Підрозділ.Pointer.Назва}"
    ...
    {
        CommonForms_DocumentMovementThroughRegisters.Create(new ПереміщенняТоварівНаСкладі_Pointer(uniqueID));
    }
