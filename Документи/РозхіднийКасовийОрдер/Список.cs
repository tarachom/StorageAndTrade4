...
[GObject.Subclass<DocumentFormJournalFull>("List_2mVRNVNz20D5tjKvNEZsg")]
public partial class РозхіднийКасовийОрдер_Список : DocumentFormJournalFull
{
    ...
    public static РозхіднийКасовийОрдер_Список New()
    {
        РозхіднийКасовийОрдер_Список list = NewWithProperties([]);
