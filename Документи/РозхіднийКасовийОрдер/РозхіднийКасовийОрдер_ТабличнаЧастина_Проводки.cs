...
/*
        РозхіднийКасовийОрдер_ТабличнаЧастина_Проводки.cs
        Таблична Частина
*/
...
[GObject.Subclass<DocumentFormTablePart>("TablePart_f5GeAcdOk32fCQR3cyxbQ")]
partial class РозхіднийКасовийОрдер_ТабличнаЧастина_Проводки : DocumentFormTablePart
{
    #region Data
    ...
    public РозхіднийКасовийОрдер_Object? ЕлементВласник { get; set; }
    public РозхіднийКасовийОрдер_Елемент? ЕлементВласникФорма { get; set; }
    ...
    public static РозхіднийКасовийОрдер_ТабличнаЧастина_Проводки New()
    {
        РозхіднийКасовийОрдер_ТабличнаЧастина_Проводки tablePart = NewWithProperties([]);
    ...
    protected override void Columns()
    {
        ...
        //Аналітика1, Аналітика2, Аналітика3
        {
            ...
            factory.OnSetup += (_, args) =>
            {
                ...
                cell.Аналітика1.BoundConfType = "Документи.РозхіднийКасовийОрдер.Проводки.Аналітика1";
                cell.Аналітика2.BoundConfType = "Документи.РозхіднийКасовийОрдер.Проводки.Аналітика2";
                cell.Аналітика3.BoundConfType = "Документи.РозхіднийКасовийОрдер.Проводки.Аналітика3";
        ...
        //КорАналітика1, КорАналітика2, КорАналітика3
        {
            ...
            factory.OnSetup += (_, args) =>
            {
                ...
                cell.Аналітика1.BoundConfType = "Документи.РозхіднийКасовийОрдер.Проводки.КорАналітика1";
                cell.Аналітика2.BoundConfType = "Документи.РозхіднийКасовийОрдер.Проводки.КорАналітика2";
                cell.Аналітика3.BoundConfType = "Документи.РозхіднийКасовийОрдер.Проводки.КорАналітика3";
    ...
    public override async Task LoadRecords()
    {
        ...
        {
            ЕлементВласник.Проводки_TablePart.FillJoin([РозхіднийКасовийОрдер_Проводки_TablePart.НомерРядка,]);
