...
partial class РозміщенняТоварівНаСкладі_Елемент : DocumentFormElement
{
    ...
    partial void Initialize()
    {
        ...
        //Підстава:
        Підстава.BoundConfType = "Документи.РозміщенняТоварівНаСкладі.Підстава";
    ...
    {
        РозміщенняТоварівНаСкладі_Елемент element = NewWithProperties([]);
    ...
    {
        CommonForms_DocumentMovementThroughRegisters.Create(new РозміщенняТоварівНаСкладі_Pointer(uniqueID));
    }
