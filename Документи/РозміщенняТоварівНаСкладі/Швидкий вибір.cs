...
[GObject.Subclass<DocumentFormJournalSmall>("SmallList_rgCApK19Tke0Yb9dpThIKA")]
public partial class РозміщенняТоварівНаСкладі_ШвидкийВибір : DocumentFormJournalSmall
{
    ...
    public static РозміщенняТоварівНаСкладі_ШвидкийВибір New()
    {
        РозміщенняТоварівНаСкладі_ШвидкийВибір list = NewWithProperties([]);
