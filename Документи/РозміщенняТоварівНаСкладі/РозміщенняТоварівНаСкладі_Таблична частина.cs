...
[GObject.Subclass<DocumentFormTablePart>("TablePart_3lq7alNszEG7hBgEpZ84uA")]
partial class РозміщенняТоварівНаСкладі_ТабличнаЧастина_Товари : DocumentFormTablePart
{
    #region Data
    
    [GObject.Subclass<GObject.Object>("ItemRow_3lq7alNszEG7hBgEpZ84uA")]
    ...
    public РозміщенняТоварівНаСкладі_Object? ЕлементВласник { get; set; }
    ...
    public static РозміщенняТоварівНаСкладі_ТабличнаЧастина_Товари New()
    {
        РозміщенняТоварівНаСкладі_ТабличнаЧастина_Товари tablePart = NewWithProperties([]);
