...
/*
        КорегуванняБоргу_ТабличнаЧастина_Проводки.cs
        Таблична Частина
*/
...
[GObject.Subclass<DocumentFormTablePart>("TablePart_zZGeAYiQnSjYQLvMavh9w")]
partial class КорегуванняБоргу_ТабличнаЧастина_Проводки : DocumentFormTablePart
{
    #region Data

    [GObject.Subclass<GObject.Object>("ItemRow_ebifAfCEqHaVtaR2UeDdVw")]
    ...
    {
        КорегуванняБоргу_ТабличнаЧастина_Проводки tablePart = NewWithProperties([]);
    ...
    protected override void Columns()
    {
        ...
        //Аналітика1, Аналітика2, Аналітика3
        {
            ...
            factory.OnSetup += (_, args) =>
            {
                ...
                cell.Аналітика1.BoundConfType = "Документи.КорегуванняБоргу.Проводки.Аналітика1";
                cell.Аналітика2.BoundConfType = "Документи.КорегуванняБоргу.Проводки.Аналітика2";
                cell.Аналітика3.BoundConfType = "Документи.КорегуванняБоргу.Проводки.Аналітика3";
    ...
    public override async Task LoadRecords()
    {
        ...
        {
            ЕлементВласник.Проводки_TablePart.FillJoin([КорегуванняБоргу_Проводки_TablePart.НомерРядка,]);
