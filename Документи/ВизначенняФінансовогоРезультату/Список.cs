...
[GObject.Subclass<DocumentFormJournalFull>("List_tiro070xXkaHlCT31OOdvg")]
public partial class ВизначенняФінансовогоРезультату_Список : DocumentFormJournalFull
{
    ...
    public static ВизначенняФінансовогоРезультату_Список New()
    {
        ВизначенняФінансовогоРезультату_Список list = NewWithProperties([]);
