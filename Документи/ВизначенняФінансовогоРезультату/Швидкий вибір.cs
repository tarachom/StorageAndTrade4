...
/*     
        ВизначенняФінансовогоРезультату.cs
        Список
*/
...
using ТабличнийСписок = GeneratedCode.Документи.ТабличніСписки.ВизначенняФінансовогоРезультату_Записи;
using Функції = StorageAndTrade.ВизначенняФінансовогоРезультату_Функції;

namespace StorageAndTrade;

[GObject.Subclass<DocumentFormJournalSmall>("SmallList_bDrAQcxWkyl0DIjieUwbA")]
public partial class ВизначенняФінансовогоРезультату_ШвидкийВибір : DocumentFormJournalSmall
{
    partial void Initialize()
    {
        TypeName = ВизначенняФінансовогоРезультату_Const.POINTER;
        KeyForSetting = ".Small";
        ТабличнийСписок.AddColumn(this);
        SetPagesSettings(50);
    }

    public static ВизначенняФінансовогоРезультату_ШвидкийВибір New()
    {
        ВизначенняФінансовогоРезультату_ШвидкийВибір list = NewWithProperties([]);
    ...
    {
        foreach (var uid in uniqueID)
            CommonForms_DocumentMovementThroughRegisters.Create(new ВизначенняФінансовогоРезультату_Pointer(uid));
    }
