...
/*
        БухгалтерськаОперація_Функції.cs
        Функції
*/
...
static class БухгалтерськаОперація_Функції
{
    public static List<Where> Відбори(string searchText)
    {
        ...
        [
            ...
            //Назва
            new Where(БухгалтерськаОперація_Const.Назва, Comparison.LIKE, searchText) { FuncToField = "LOWER" },
                    
            //НомерДок
            new Where(Comparison.OR, БухгалтерськаОперація_Const.НомерДок, Comparison.LIKE, searchText) { FuncToField = "LOWER" },
    ...
    {
        БухгалтерськаОперація_Елемент page = БухгалтерськаОперація_Елемент.New();
    ...
    public static async Task OpenPageList(UniqueID? uniqueID = null, Action<UniqueID>? сallBack_OnSelectPointer = null)
    {
        ...
        Program.BasicForm?.NotebookFunc.CreatePage(БухгалтерськаОперація_Const.FULLNAME, page);
        await page.SetValue();
    }
