...
using ТабличнийСписок = GeneratedCode.Документи.ТабличніСписки.ВнутрішнєСпоживанняТоварів_Записи;
using Функції = StorageAndTrade.ВнутрішнєСпоживанняТоварів_Функції;

namespace StorageAndTrade;

[GObject.Subclass<DocumentFormJournalSmall>("SmallList_L1JHKQrx40qox5mzPEsu3A")]
public partial class ВнутрішнєСпоживанняТоварів_ШвидкийВибір : DocumentFormJournalSmall
{
    partial void Initialize()
    {
        TypeName = ВнутрішнєСпоживанняТоварів_Const.POINTER;
        KeyForSetting = ".Small";
        ТабличнийСписок.AddColumn(this);
        SetPagesSettings(50);
    }

    public static ВнутрішнєСпоживанняТоварів_ШвидкийВибір New()
    {
        ВнутрішнєСпоживанняТоварів_ШвидкийВибір list = NewWithProperties([]);
    ...
    {
        foreach (var uid in uniqueID)
            CommonForms_DocumentMovementThroughRegisters.Create(new ВнутрішнєСпоживанняТоварів_Pointer(uid));
    }
