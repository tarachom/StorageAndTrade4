...
/*
        ВнутрішнєСпоживанняТоварів_ТабличнаЧастина_Проводки.cs
        Таблична Частина
*/
...
[GObject.Subclass<DocumentFormTablePart>("TablePart_45aeAY0GOXWCcOmW21afZQ")]
partial class ВнутрішнєСпоживанняТоварів_ТабличнаЧастина_Проводки : DocumentFormTablePart
{
    #region Data

    [GObject.Subclass<GObject.Object>("ItemRow_bbifAa9rX3efLecim17TA")]
    ...
    public ВнутрішнєСпоживанняТоварів_Object? ЕлементВласник { get; set; }
    public ВнутрішнєСпоживанняТоварів_Елемент? ЕлементВласникФорма { get; set; }
    ...
    public static ВнутрішнєСпоживанняТоварів_ТабличнаЧастина_Проводки New()
    {
        ВнутрішнєСпоживанняТоварів_ТабличнаЧастина_Проводки tablePart = NewWithProperties([]);
    ...
    protected override void Columns()
    {
        ...
        //Аналітика1, Аналітика2, Аналітика3
        {
            ...
            factory.OnSetup += (_, args) =>
            {
                ...
                cell.Аналітика1.BoundConfType = "Документи.ВнутрішнєСпоживанняТоварів.Проводки.Аналітика1";
                cell.Аналітика2.BoundConfType = "Документи.ВнутрішнєСпоживанняТоварів.Проводки.Аналітика2";
                cell.Аналітика3.BoundConfType = "Документи.ВнутрішнєСпоживанняТоварів.Проводки.Аналітика3";
        ...
        //КорАналітика1, КорАналітика2, КорАналітика3
        {
            ...
            factory.OnSetup += (_, args) =>
            {
                ...
                cell.Аналітика1.BoundConfType = "Документи.ВнутрішнєСпоживанняТоварів.Проводки.КорАналітика1";
                cell.Аналітика2.BoundConfType = "Документи.ВнутрішнєСпоживанняТоварів.Проводки.КорАналітика2";
                cell.Аналітика3.BoundConfType = "Документи.ВнутрішнєСпоживанняТоварів.Проводки.КорАналітика3";
    ...
    public override async Task LoadRecords()
    {
        ...
        {
            ЕлементВласник.Проводки_TablePart.FillJoin([ВнутрішнєСпоживанняТоварів_Проводки_TablePart.НомерРядка,]);
