...
[GObject.Subclass<DocumentFormJournalFull>("List_ZKc2DVIyjki2KpLFuxbC9Q")]
public partial class ВнутрішнєСпоживанняТоварів_Список : DocumentFormJournalFull
{
    ...
    public static ВнутрішнєСпоживанняТоварів_Список New()
    {
        ВнутрішнєСпоживанняТоварів_Список list = NewWithProperties([]);
