...
[GObject.Subclass<DocumentFormJournalSmall>("SmallList_JEv9E0dupUaBqshal8p2Sw")]
public partial class ПоступленняТоварівТаПослуг_ШвидкийВибір : DocumentFormJournalSmall
{
    ...
    public static ПоступленняТоварівТаПослуг_ШвидкийВибір New()
    {
        ПоступленняТоварівТаПослуг_ШвидкийВибір list = NewWithProperties([]);
