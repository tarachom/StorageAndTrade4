...
{
    public ПоступленняТоварівТаПослуг_Object Елемент { get; init; } = new();
    ...
    ПоступленняТоварівТаПослуг_ТабличнаЧастина_Проводки Проводки = ПоступленняТоварівТаПослуг_ТабличнаЧастина_Проводки.New();
    ...
    partial void Initialize()
    {
        ...
        ЗамовленняПостачальнику.Caption = "Замовлення постачальнику";
