...
/*
        ПоступленняТоварівТаПослуг_ТабличнаЧастина_Проводки.cs
        Таблична Частина
*/
...
[GObject.Subclass<DocumentFormTablePart>("TablePart_C4OeAQM2f3oompUIKnUsg")]
partial class ПоступленняТоварівТаПослуг_ТабличнаЧастина_Проводки : DocumentFormTablePart
{
    #region Data

    [GObject.Subclass<GObject.Object>("ItemRow_I9KfAT9753uRnZT0CiqmNQ")]
    ...
    public ПоступленняТоварівТаПослуг_Object? ЕлементВласник { get; set; }
    public ПоступленняТоварівТаПослуг_Елемент? ЕлементВласникФорма { get; set; }
    ...
    public static ПоступленняТоварівТаПослуг_ТабличнаЧастина_Проводки New()
    {
        ПоступленняТоварівТаПослуг_ТабличнаЧастина_Проводки tablePart = NewWithProperties([]);
    ...
    protected override void Columns()
    {
        ...
        //Аналітика1, Аналітика2, Аналітика3
        {
            ...
            factory.OnSetup += (_, args) =>
            {
                ...
                cell.Аналітика1.BoundConfType = "Документи.ПоступленняТоварівТаПослуг.Проводки.Аналітика1";
                cell.Аналітика2.BoundConfType = "Документи.ПоступленняТоварівТаПослуг.Проводки.Аналітика2";
                cell.Аналітика3.BoundConfType = "Документи.ПоступленняТоварівТаПослуг.Проводки.Аналітика3";
        ...
        //КорАналітика1, КорАналітика2, КорАналітика3
        {
            ...
            factory.OnSetup += (_, args) =>
            {
                ...
                cell.Аналітика1.BoundConfType = "Документи.ПоступленняТоварівТаПослуг.Проводки.КорАналітика1";
                cell.Аналітика2.BoundConfType = "Документи.ПоступленняТоварівТаПослуг.Проводки.КорАналітика2";
                cell.Аналітика3.BoundConfType = "Документи.ПоступленняТоварівТаПослуг.Проводки.КорАналітика3";
    ...
    public override async Task LoadRecords()
    {
        ...
        {
            ЕлементВласник.Проводки_TablePart.FillJoin([ПоступленняТоварівТаПослуг_Проводки_TablePart.НомерРядка,]);
