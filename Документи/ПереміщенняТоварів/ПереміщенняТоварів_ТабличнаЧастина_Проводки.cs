...
/*
        ПереміщенняТоварів_ТабличнаЧастина_Проводки.cs
        Таблична Частина
*/
...
[GObject.Subclass<DocumentFormTablePart>("TablePart_PY6eAVy0836OnZthf9ymw")]
partial class ПереміщенняТоварів_ТабличнаЧастина_Проводки : DocumentFormTablePart
{
    #region Data

    [GObject.Subclass<GObject.Object>("ItemRow_TLifAdcVpXWCKLFne4UEog")]
    ...
    public ПереміщенняТоварів_Object? ЕлементВласник { get; set; }
    public ПереміщенняТоварів_Елемент? ЕлементВласникФорма { get; set; }
    ...
    public static ПереміщенняТоварів_ТабличнаЧастина_Проводки New()
    {
        ПереміщенняТоварів_ТабличнаЧастина_Проводки tablePart = NewWithProperties([]);
    ...
    protected override void Columns()
    {
        ...
        //Аналітика1, Аналітика2, Аналітика3
        {
            ...
            factory.OnSetup += (_, args) =>
            {
                ...
                cell.Аналітика1.BoundConfType = "Документи.ПереміщенняТоварів.Проводки.Аналітика1";
                cell.Аналітика2.BoundConfType = "Документи.ПереміщенняТоварів.Проводки.Аналітика2";
                cell.Аналітика3.BoundConfType = "Документи.ПереміщенняТоварів.Проводки.Аналітика3";
        ...
        //КорАналітика1, КорАналітика2, КорАналітика3
        {
            ...
            factory.OnSetup += (_, args) =>
            {
                ...
                cell.Аналітика1.BoundConfType = "Документи.ПереміщенняТоварів.Проводки.КорАналітика1";
                cell.Аналітика2.BoundConfType = "Документи.ПереміщенняТоварів.Проводки.КорАналітика2";
                cell.Аналітика3.BoundConfType = "Документи.ПереміщенняТоварів.Проводки.КорАналітика3";
    ...
    public override async Task LoadRecords()
    {
        ...
        {
            ЕлементВласник.Проводки_TablePart.FillJoin([ПереміщенняТоварів_Проводки_TablePart.НомерРядка,]);
