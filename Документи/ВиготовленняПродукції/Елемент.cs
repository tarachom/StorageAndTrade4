...
partial class ВиготовленняПродукції_Елемент : DocumentFormElement
{
    ...
    Склади_PointerControl СкладГотовихВиробів = Склади_PointerControl.New();
    ...
    partial void Initialize()
    {
        ...
        //СкладГотовихВиробів:
        СкладГотовихВиробів.Caption = "Склад готових виробів";
        СкладГотовихВиробів.WidthPresentation = 300;
    ...
    {
        // СкладГотовихВиробів
        CreateField(vBox, null, СкладГотовихВиробів);
    ...
    public override async Task AssignValue()
    {
        if (IsNew)
        {
            ...
            Елемент.СкладГотовихВиробів = await ЗначенняТипові.ОсновнийСклад();
        ...
        СкладГотовихВиробів.Pointer = Елемент.СкладГотовихВиробів;
    ...
    protected override void GetValue()
    {
        ...
        Елемент.СкладГотовихВиробів = СкладГотовихВиробів.Pointer;
