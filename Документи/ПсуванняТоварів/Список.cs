...
using ТабличнийСписок = GeneratedCode.Документи.ТабличніСписки.ПсуванняТоварів_Записи;
using Функції = StorageAndTrade.ПсуванняТоварів_Функції;

namespace StorageAndTrade;

[GObject.Subclass<DocumentFormJournalFull>("List_h7dZJ9adwkqeX5bYITkXcw")]
public partial class ПсуванняТоварів_Список : DocumentFormJournalFull
{
    ...
    public static ПсуванняТоварів_Список New()
    {
        ПсуванняТоварів_Список list = NewWithProperties([]);
