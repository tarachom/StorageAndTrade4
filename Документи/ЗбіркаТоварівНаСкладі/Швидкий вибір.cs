...
using ТабличнийСписок = GeneratedCode.Документи.ТабличніСписки.ЗбіркаТоварівНаСкладі_Записи;
using Функції = StorageAndTrade.ЗбіркаТоварівНаСкладі_Функції;

namespace StorageAndTrade;

[GObject.Subclass<DocumentFormJournalSmall>("SmallList_2z3zhApbrEiEYX8cI73o2A")]
public partial class ЗбіркаТоварівНаСкладі_ШвидкийВибір : DocumentFormJournalSmall
{
    partial void Initialize()
    {
        TypeName = ЗбіркаТоварівНаСкладі_Const.POINTER;
        KeyForSetting = ".Small";
        ТабличнийСписок.AddColumn(this);
        SetPagesSettings(50);
    }

    public static ЗбіркаТоварівНаСкладі_ШвидкийВибір New()
    {
        ЗбіркаТоварівНаСкладі_ШвидкийВибір list = NewWithProperties([]);
