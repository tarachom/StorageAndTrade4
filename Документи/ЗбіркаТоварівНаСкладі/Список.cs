...
[GObject.Subclass<DocumentFormJournalFull>("List_R4XtSZ4DbkKNdqnieUxqmw")]
public partial class ЗбіркаТоварівНаСкладі_Список : DocumentFormJournalFull
{
    ...
    public static ЗбіркаТоварівНаСкладі_Список New()
    {
        ЗбіркаТоварівНаСкладі_Список list = NewWithProperties([]);
