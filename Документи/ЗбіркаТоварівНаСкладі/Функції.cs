...
static class ЗбіркаТоварівНаСкладі_Функції
{
    ...
    {
        ЗбіркаТоварівНаСкладі_Елемент page = ЗбіркаТоварівНаСкладі_Елемент.New();
    ...
    public static async Task OpenPageList(UniqueID? uniqueID = null, Action<UniqueID>? сallBack_OnSelectPointer = null)
    {
        ...
        Program.BasicForm?.NotebookFunc.CreatePage(ЗбіркаТоварівНаСкладі_Const.FULLNAME, page);
        await page.SetValue();
    }
