...
/*     
        СписанняВитратМайбутніхПеріодів.cs
        Список
*/
...
using ТабличнийСписок = GeneratedCode.Документи.ТабличніСписки.СписанняВитратМайбутніхПеріодів_Записи;
using Функції = StorageAndTrade.СписанняВитратМайбутніхПеріодів_Функції;

namespace StorageAndTrade;

[GObject.Subclass<DocumentFormJournalSmall>("SmallList_W6eAXnP6nGeTvTcs0JWGg")]
public partial class СписанняВитратМайбутніхПеріодів_ШвидкийВибір : DocumentFormJournalSmall
{
    partial void Initialize()
    {
        TypeName = СписанняВитратМайбутніхПеріодів_Const.POINTER;
        KeyForSetting = ".Small";
        ТабличнийСписок.AddColumn(this);
        SetPagesSettings(50);
    }

    public static СписанняВитратМайбутніхПеріодів_ШвидкийВибір New()
    {
        СписанняВитратМайбутніхПеріодів_ШвидкийВибір list = NewWithProperties([]);
    ...
    {
        foreach (var uid in uniqueID)
            CommonForms_DocumentMovementThroughRegisters.Create(new СписанняВитратМайбутніхПеріодів_Pointer(uid));
    }
