...
[GObject.Subclass<DocumentFormJournalFull>("List_W6eAUHP83Cp3bo9kYKRNw")]
public partial class СписанняВитратМайбутніхПеріодів_Список : DocumentFormJournalFull
{
    ...
    public static СписанняВитратМайбутніхПеріодів_Список New()
    {
        СписанняВитратМайбутніхПеріодів_Список list = NewWithProperties([]);
