...
using ТабличнийСписок = GeneratedCode.Документи.ТабличніСписки.ВиплатаЗаробітноїПлати_Записи;
using Функції = StorageAndTrade.ВиплатаЗаробітноїПлати_Функції;

namespace StorageAndTrade;

[GObject.Subclass<DocumentFormJournalSmall>("SmallList_VWvEiHz1Ukmau91KPywYjw")]
public partial class ВиплатаЗаробітноїПлати_ШвидкийВибір : DocumentFormJournalSmall
{
    partial void Initialize()
    {
        TypeName = ВиплатаЗаробітноїПлати_Const.POINTER;
        KeyForSetting = ".Small";
        ТабличнийСписок.AddColumn(this);
        SetPagesSettings(50);
    }

    public static ВиплатаЗаробітноїПлати_ШвидкийВибір New()
    {
        ВиплатаЗаробітноїПлати_ШвидкийВибір list = NewWithProperties([]);
    ...
    {
        foreach (var uid in uniqueID)
            CommonForms_DocumentMovementThroughRegisters.Create(new ВиплатаЗаробітноїПлати_Pointer(uid));
    }
