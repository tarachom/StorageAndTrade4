...
[GObject.Subclass<DocumentFormJournalFull>("List_2WOWTCfSRk6SwwvcQYGbyw")]
public partial class ВиплатаЗаробітноїПлати_Список : DocumentFormJournalFull
{
    ...
    public static ВиплатаЗаробітноїПлати_Список New()
    {
        ВиплатаЗаробітноїПлати_Список list = NewWithProperties([]);
