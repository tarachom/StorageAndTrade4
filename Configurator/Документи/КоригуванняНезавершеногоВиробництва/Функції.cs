...
static class КоригуванняНезавершеногоВиробництва_Функції
{
    ...
    {
        КоригуванняНезавершеногоВиробництва_Objest Обєкт = new();
        if (await Обєкт.Read(uniqueID))
        {
            КоригуванняНезавершеногоВиробництва_Objest Новий = await Обєкт.Copy(true);
            await Новий.Save();
    ...
    {
        КоригуванняНезавершеногоВиробництва_Objest? Обєкт = await new КоригуванняНезавершеногоВиробництва_Pointer(uniqueID).GetDocumentObject(true);
