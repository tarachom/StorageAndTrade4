...
{
    public static async Task<bool> Spend(КоригуванняНезавершеногоВиробництва_Objest ДокументОбєкт)
    {
        try
        {
    ...
    public static Task Clear(КоригуванняНезавершеногоВиробництва_Objest ДокументОбєкт)
    {
