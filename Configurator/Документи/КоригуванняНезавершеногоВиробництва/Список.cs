...
[GObject.Subclass<DocumentFormJournalFull>("List_km6eAcsQMnWYK67leyyqAA")]
public partial class КоригуванняНезавершеногоВиробництва_Список : DocumentFormJournalFull
{
    ...
    public static КоригуванняНезавершеногоВиробництва_Список New()
    {
        КоригуванняНезавершеногоВиробництва_Список list = NewWithProperties([]);
