...
/*     
        КоригуванняНезавершеногоВиробництва.cs
        Список
*/
...
using ТабличнийСписок = GeneratedCode.Документи.ТабличніСписки.КоригуванняНезавершеногоВиробництва_Записи;
using Функції = StorageAndTrade.КоригуванняНезавершеногоВиробництва_Функції;

namespace StorageAndTrade;

[GObject.Subclass<DocumentFormJournalSmall>("SmallList_km6eAfsQ9HSJi4lR3aul1w")]
public partial class КоригуванняНезавершеногоВиробництва_ШвидкийВибір : DocumentFormJournalSmall
{
    partial void Initialize()
    {
        TypeName = КоригуванняНезавершеногоВиробництва_Const.POINTER;
        KeyForSetting = ".Small";
        ТабличнийСписок.AddColumn(this);
        SetPagesSettings(50);
    }

    public static КоригуванняНезавершеногоВиробництва_ШвидкийВибір New()
    {
        КоригуванняНезавершеногоВиробництва_ШвидкийВибір list = NewWithProperties([]);
    ...
    {
        foreach (var uid in uniqueID)
            CommonForms_DocumentMovementThroughRegisters.Create(new КоригуванняНезавершеногоВиробництва_Pointer(uid));
    }
