...
using ТабличнийСписок = GeneratedCode.Документи.ТабличніСписки.ПереміщенняОсновнихЗасобів_Записи;
using Функції = StorageAndTrade.ПереміщенняОсновнихЗасобів_Функції;

namespace StorageAndTrade;

[GObject.Subclass<DocumentFormJournalSmall>("SmallList_2m6eAbHzXK5UiM4hNOIQg")]
public partial class ПереміщенняОсновнихЗасобів_ШвидкийВибір : DocumentFormJournalSmall
{
    partial void Initialize()
    {
        TypeName = ПереміщенняОсновнихЗасобів_Const.POINTER;
        KeyForSetting = ".Small";
        ТабличнийСписок.AddColumn(this);
        SetPagesSettings(50);
    }

    public static ПереміщенняОсновнихЗасобів_ШвидкийВибір New()
    {
        ПереміщенняОсновнихЗасобів_ШвидкийВибір list = NewWithProperties([]);
    ...
    {
        foreach (var uid in uniqueID)
            CommonForms_DocumentMovementThroughRegisters.Create(new ПереміщенняОсновнихЗасобів_Pointer(uid));
    }
