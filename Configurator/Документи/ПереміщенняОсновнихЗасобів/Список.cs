...
[GObject.Subclass<DocumentFormJournalFull>("List_2m6eAXz73GgD4RXPSggJw")]
public partial class ПереміщенняОсновнихЗасобів_Список : DocumentFormJournalFull
{
    ...
    public static ПереміщенняОсновнихЗасобів_Список New()
    {
        ПереміщенняОсновнихЗасобів_Список list = NewWithProperties([]);
