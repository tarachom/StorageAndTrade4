...
using ТабличнийСписок = GeneratedCode.Документи.ТабличніСписки.КоригуванняПДВ_Записи;
using Функції = StorageAndTrade.КоригуванняПДВ_Функції;

namespace StorageAndTrade;

[GObject.Subclass<DocumentFormJournalSmall>("SmallList_k26eAR2EMH66XhMVNpKig")]
public partial class КоригуванняПДВ_ШвидкийВибір : DocumentFormJournalSmall
{
    partial void Initialize()
    {
        TypeName = КоригуванняПДВ_Const.POINTER;
        KeyForSetting = ".Small";
        ТабличнийСписок.AddColumn(this);
        SetPagesSettings(50);
    }

    public static КоригуванняПДВ_ШвидкийВибір New()
    {
        КоригуванняПДВ_ШвидкийВибір list = NewWithProperties([]);
    ...
    {
        foreach (var uid in uniqueID)
            CommonForms_DocumentMovementThroughRegisters.Create(new КоригуванняПДВ_Pointer(uid));
    }
