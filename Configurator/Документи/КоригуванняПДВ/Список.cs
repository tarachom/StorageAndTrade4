...
[GObject.Subclass<DocumentFormJournalFull>("List_k26eAe2Dznhnaa5qtv4g")]
public partial class КоригуванняПДВ_Список : DocumentFormJournalFull
{
    ...
    public static КоригуванняПДВ_Список New()
    {
        КоригуванняПДВ_Список list = NewWithProperties([]);
