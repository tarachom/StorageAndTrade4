...
[GObject.Subclass<DocumentFormJournalFull>("List_mCbognO5TE6QsAS2YAeRdg")]
public partial class Амортизація_Список : DocumentFormJournalFull
{
    ...
    public static Амортизація_Список New()
    {
        Амортизація_Список list = NewWithProperties([]);
