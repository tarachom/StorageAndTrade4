...
[GObject.Subclass<DocumentFormJournalFull>("List_G6eAVwuwnO87mj9zeaPiQ")]
public partial class РозподілІншихВитрат_Список : DocumentFormJournalFull
{
    ...
    public static РозподілІншихВитрат_Список New()
    {
        РозподілІншихВитрат_Список list = NewWithProperties([]);
