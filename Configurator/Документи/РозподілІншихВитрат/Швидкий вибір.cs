...
using ТабличнийСписок = GeneratedCode.Документи.ТабличніСписки.РозподілІншихВитрат_Записи;
using Функції = StorageAndTrade.РозподілІншихВитрат_Функції;

namespace StorageAndTrade;

[GObject.Subclass<DocumentFormJournalSmall>("SmallList_G6eAZQumHWo5YsBvT5P8Q")]
public partial class РозподілІншихВитрат_ШвидкийВибір : DocumentFormJournalSmall
{
    partial void Initialize()
    {
        TypeName = РозподілІншихВитрат_Const.POINTER;
        KeyForSetting = ".Small";
        ТабличнийСписок.AddColumn(this);
        SetPagesSettings(50);
    }

    public static РозподілІншихВитрат_ШвидкийВибір New()
    {
        РозподілІншихВитрат_ШвидкийВибір list = NewWithProperties([]);
    ...
    {
        foreach (var uid in uniqueID)
            CommonForms_DocumentMovementThroughRegisters.Create(new РозподілІншихВитрат_Pointer(uid));
    }
