...
/*
        РозподілІншихВитрат_Елемент.cs
        Елемент
*/
...
partial class РозподілІншихВитрат_Елемент : DocumentFormElement
{
    ...
    partial void Initialize()
    {
        ...
        CreateDocName(РозподілІншихВитрат_Const.FULLNAME, НомерДок, ДатаДок);
        ...
        CreateField(HBoxComment, "Коментар:", Коментар);
            ...
            //Підстава:
            Підстава.BoundConfType = "Документи.РозподілІншихВитрат.Підстава";
                
    }

    public static РозподілІншихВитрат_Елемент New()
    {
        РозподілІншихВитрат_Елемент element = NewWithProperties([]);
    ...
    {
        CommonForms_DocumentMovementThroughRegisters.Create(new РозподілІншихВитрат_Pointer(uniqueID));
    }
