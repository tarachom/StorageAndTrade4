...
[GObject.Subclass<DocumentFormJournalSmall>("SmallList_326eAYn4tXmVvoX6WlpaBg")]
public partial class ПлатіжнеДорученняВхідне_ШвидкийВибір : DocumentFormJournalSmall
{
    ...
    public static ПлатіжнеДорученняВхідне_ШвидкийВибір New()
    {
        ПлатіжнеДорученняВхідне_ШвидкийВибір list = NewWithProperties([]);
