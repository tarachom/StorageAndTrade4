...
[GObject.Subclass<DocumentFormJournalFull>("List_2W6eAdcARX60dn4SzT54Cg")]
public partial class ПередачаОсновнихЗасобів_Список : DocumentFormJournalFull
{
    ...
    public static ПередачаОсновнихЗасобів_Список New()
    {
        ПередачаОсновнихЗасобів_Список list = NewWithProperties([]);
