...
[GObject.Subclass<DocumentFormJournalFull>("List_6m6eAXVx23CcV3z58VV7A")]
public partial class ПрибуткуванняТоварівВПереробку_Список : DocumentFormJournalFull
{
    ...
    public static ПрибуткуванняТоварівВПереробку_Список New()
    {
        ПрибуткуванняТоварівВПереробку_Список list = NewWithProperties([]);
