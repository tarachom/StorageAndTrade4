...
/*     
        ПрибуткуванняТоварівВПереробку.cs
        Список
*/
...
using ТабличнийСписок = GeneratedCode.Документи.ТабличніСписки.ПрибуткуванняТоварівВПереробку_Записи;
using Функції = StorageAndTrade.ПрибуткуванняТоварівВПереробку_Функції;

namespace StorageAndTrade;

[GObject.Subclass<DocumentFormJournalSmall>("SmallList_6m6eAadx9nOo7jxmHeDvA")]
public partial class ПрибуткуванняТоварівВПереробку_ШвидкийВибір : DocumentFormJournalSmall
{
    partial void Initialize()
    {
        TypeName = ПрибуткуванняТоварівВПереробку_Const.POINTER;
        KeyForSetting = ".Small";
        ТабличнийСписок.AddColumn(this);
        SetPagesSettings(50);
    }

    public static ПрибуткуванняТоварівВПереробку_ШвидкийВибір New()
    {
        ПрибуткуванняТоварівВПереробку_ШвидкийВибір list = NewWithProperties([]);
    ...
    {
        foreach (var uid in uniqueID)
            CommonForms_DocumentMovementThroughRegisters.Create(new ПрибуткуванняТоварівВПереробку_Pointer(uid));
    }
