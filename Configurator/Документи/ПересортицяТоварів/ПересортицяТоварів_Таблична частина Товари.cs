...
/*
        ПересортицяТоварів_ТабличнаЧастина_Товари.cs
        Таблична Частина
*/
...
[GObject.Subclass<DocumentFormTablePart>("TablePart_lTCcxWMwqUOJYr02kw3Q")]
partial class ПересортицяТоварів_ТабличнаЧастина_Товари : DocumentFormTablePart
{
    #region Data
    
    [GObject.Subclass<GObject.Object>("ItemRow_lTCcxWMwqUOJYr02kw3Q")]
    ...
    public ПересортицяТоварів_Objest? ЕлементВласник { get; set; }
    ...
    public static ПересортицяТоварів_ТабличнаЧастина_Товари New()
    {
        ПересортицяТоварів_ТабличнаЧастина_Товари tablePart = NewWithProperties([]);
    ...
    public override async ValueTask LoadRecords()
    {
        ...
        if (ЕлементВласник != null) 
        {
            ...
            ЕлементВласник.Товари_TablePart.FillJoin([ПересортицяТоварів_Товари_TablePart.НомерРядка,]);
