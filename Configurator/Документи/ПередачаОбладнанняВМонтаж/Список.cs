...
[GObject.Subclass<DocumentFormJournalFull>("List_126eAVrjg3StIWfY0SS2Zw")]
public partial class ПередачаОбладнанняВМонтаж_Список : DocumentFormJournalFull
{
    ...
    public static ПередачаОбладнанняВМонтаж_Список New()
    {
        ПередачаОбладнанняВМонтаж_Список list = NewWithProperties([]);
