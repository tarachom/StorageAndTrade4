...
class ПоверненняТоварівПостачальнику_ТабличнаЧастина_Товари : DocumentFormTablePart
{
    ...
    protected override void Columns()
    {
        ...
        //ДокументПоступлення
        {
            ...
            {
                ListItem listItem = (ListItem)args.Object;
                var cell = new ПоступленняТоварівТаПослуг_PointerTablePartCell();
            ...
            {
                ListItem listItem = (ListItem)args.Object;
                var cell = (ПоступленняТоварівТаПослуг_PointerTablePartCell?)listItem.Child;
                ItemRow? row = (ItemRow?)listItem.Item;
                if (cell != null && row != null)
                {
