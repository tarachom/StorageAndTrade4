...
partial class ПоверненняТоварівПостачальнику_ТабличнаЧастина_Товари : DocumentFormTablePart
{
    ...
    [GObject.Subclass<GObject.Object>("ItemRow_p7J74337L0O7fdK2a6hCQA")]
    public partial class ItemRow : IRowSubclassTablePart
    {
        ...
        public Action? Сhanged_ДокументПоступлення;
        ...
        */
        ...
        public GObject.Object Copy()
        {
            ...
            itemRow.Ціна = Ціна;
            itemRow.Сума = Сума;
            itemRow.ДокументПоступлення = ДокументПоступлення.Copy();
    ...
    public ПоверненняТоварівПостачальнику_ТабличнаЧастина_Товари() : base(Program.BasicForm?.NotebookFunc)
    {
