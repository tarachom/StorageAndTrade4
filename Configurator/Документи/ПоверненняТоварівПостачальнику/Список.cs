...
public class ПоверненняТоварівПостачальнику_Список : DocumentFormJournalFull
{
    public ПоверненняТоварівПостачальнику_Список() : base(Program.BasicForm?.NotebookFunc)
    {
