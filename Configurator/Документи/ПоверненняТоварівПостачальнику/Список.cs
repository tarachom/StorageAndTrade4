...
[GObject.Subclass<DocumentFormJournalFull>("List_VlXGw6cVV06LLmLqVqP3OA")]
public partial class ПоверненняТоварівПостачальнику_Список : DocumentFormJournalFull
{
    ...
    public static ПоверненняТоварівПостачальнику_Список New()
    {
        ПоверненняТоварівПостачальнику_Список list = NewWithProperties([]);
