...
public class ПоверненняТоварівПостачальнику_PointerTablePartCell : PointerTablePartCell
{
    ...
    {
        Pointer = new ПоверненняТоварівПостачальнику_Pointer(p ?? new UnigueID());
