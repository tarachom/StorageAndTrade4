...
public class ПоверненняТоварівПостачальнику_ШвидкийВибір : DocumentFormJournalSmall
{
    public ПоверненняТоварівПостачальнику_ШвидкийВибір() : base(Program.BasicForm?.NotebookFunc)
    {
