...
using ТабличнийСписок = GeneratedCode.Документи.ТабличніСписки.ПоверненняТоварівПостачальнику_Записи;
using Функції = StorageAndTrade.ПоверненняТоварівПостачальнику_Функції;

namespace StorageAndTrade;

[GObject.Subclass<DocumentFormJournalSmall>("SmallList_pYd765hQxUCuWDSSc30aeA")]
public partial class ПоверненняТоварівПостачальнику_ШвидкийВибір : DocumentFormJournalSmall
{
    partial void Initialize()
    {
        TypeName = ПоверненняТоварівПостачальнику_Const.POINTER;
        KeyForSetting = ".Small";
        ТабличнийСписок.AddColumn(this);
        SetPagesSettings(50);
    }

    public static ПоверненняТоварівПостачальнику_ШвидкийВибір New()
    {
        ПоверненняТоварівПостачальнику_ШвидкийВибір list = NewWithProperties([]);
