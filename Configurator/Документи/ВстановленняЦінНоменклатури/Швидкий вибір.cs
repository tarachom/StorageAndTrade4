...
using ТабличнийСписок = GeneratedCode.Документи.ТабличніСписки.ВстановленняЦінНоменклатури_Записи;
using Функції = StorageAndTrade.ВстановленняЦінНоменклатури_Функції;

namespace StorageAndTrade;

[GObject.Subclass<DocumentFormJournalSmall>("SmallList_m4y6oOXr50uL72AdlCMcNA")]
public partial class ВстановленняЦінНоменклатури_ШвидкийВибір : DocumentFormJournalSmall
{
    partial void Initialize()
    {
        TypeName = ВстановленняЦінНоменклатури_Const.POINTER;
        KeyForSetting = ".Small";
        ТабличнийСписок.AddColumn(this);
        SetPagesSettings(50);
    }

    public static ВстановленняЦінНоменклатури_ШвидкийВибір New()
    {
        ВстановленняЦінНоменклатури_ШвидкийВибір list = NewWithProperties([]);
    ...
    protected override void ReportSpendTheDocument(UniqueID[] uniqueID)
    {
        foreach (var uid in uniqueID)
            CommonForms_DocumentMovementThroughRegisters.Create(new ВстановленняЦінНоменклатури_Pointer(uid));
    }
