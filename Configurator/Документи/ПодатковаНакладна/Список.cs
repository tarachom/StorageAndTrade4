...
[GObject.Subclass<DocumentFormJournalFull>("List_4m6eAUzArH9OujDlw0j6w")]
public partial class ПодатковаНакладна_Список : DocumentFormJournalFull
{
    ...
    public static ПодатковаНакладна_Список New()
    {
        ПодатковаНакладна_Список list = NewWithProperties([]);
