...
partial class ПоверненняТоварівВідКлієнта_ТабличнаЧастина_Товари : DocumentFormTablePart
{
    ...
    [GObject.Subclass<GObject.Object>("ItemRow_2bNhT39YS06WUTvASp1rMA")]
    public partial class ItemRow : IRowTablePart
    {
        ...
        public Action? Сhanged_ДокументРеалізації;
        ...
        */
        ...
        public GObject.Object Copy()
        {
            ...
            itemRow.Ціна = Ціна;
            itemRow.Сума = Сума;
            itemRow.ДокументРеалізації = ДокументРеалізації.Copy();
    ...
    public ПоверненняТоварівВідКлієнта_ТабличнаЧастина_Товари() : base(Program.BasicForm?.NotebookFunc)
    {
