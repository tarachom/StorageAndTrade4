...
class ПоверненняТоварівВідКлієнта_ТабличнаЧастина_Товари : DocumentFormTablePart
{
    ...
    protected override void Columns()
    {
        ...
        //ДокументРеалізації
        {
            ...
            {
                ListItem listItem = (ListItem)args.Object;
                var cell = new РеалізаціяТоварівТаПослуг_PointerTablePartCell();
            ...
            {
                ListItem listItem = (ListItem)args.Object;
                var cell = (РеалізаціяТоварівТаПослуг_PointerTablePartCell?)listItem.Child;
                ItemRow? row = (ItemRow?)listItem.Item;
                if (cell != null && row != null)
                {
