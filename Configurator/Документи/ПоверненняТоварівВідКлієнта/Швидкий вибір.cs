...
public class ПоверненняТоварівВідКлієнта_ШвидкийВибір : DocumentFormJournalSmall
{
    public ПоверненняТоварівВідКлієнта_ШвидкийВибір() : base(Program.BasicForm?.NotebookFunc)
    {
