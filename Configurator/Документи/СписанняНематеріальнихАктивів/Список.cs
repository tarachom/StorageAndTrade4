...
[GObject.Subclass<DocumentFormJournalFull>("List_26eAX5UgHaNDgPAiqwaKA")]
public partial class СписанняНематеріальнихАктивів_Список : DocumentFormJournalFull
{
    ...
    public static СписанняНематеріальнихАктивів_Список New()
    {
        СписанняНематеріальнихАктивів_Список list = NewWithProperties([]);
