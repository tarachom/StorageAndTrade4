...
/*     
        СписанняНематеріальнихАктивів.cs
        Список
*/
...
using ТабличнийСписок = GeneratedCode.Документи.ТабличніСписки.СписанняНематеріальнихАктивів_Записи;
using Функції = StorageAndTrade.СписанняНематеріальнихАктивів_Функції;

namespace StorageAndTrade;

[GObject.Subclass<DocumentFormJournalSmall>("SmallList_26eAfesMHCAa2P0kPP8hw")]
public partial class СписанняНематеріальнихАктивів_ШвидкийВибір : DocumentFormJournalSmall
{
    partial void Initialize()
    {
        TypeName = СписанняНематеріальнихАктивів_Const.POINTER;
        KeyForSetting = ".Small";
        ТабличнийСписок.AddColumn(this);
        SetPagesSettings(50);
    }

    public static СписанняНематеріальнихАктивів_ШвидкийВибір New()
    {
        СписанняНематеріальнихАктивів_ШвидкийВибір list = NewWithProperties([]);
    ...
    {
        foreach (var uid in uniqueID)
            CommonForms_DocumentMovementThroughRegisters.Create(new СписанняНематеріальнихАктивів_Pointer(uid));
    }
