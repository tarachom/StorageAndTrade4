...
[GObject.Subclass<DocumentFormJournalFull>("List_7m6eAeeQ6XqtmkOYmlmmZg")]
public partial class РемонтОсновнихЗасобів_Список : DocumentFormJournalFull
{
    ...
    public static РемонтОсновнихЗасобів_Список New()
    {
        РемонтОсновнихЗасобів_Список list = NewWithProperties([]);
