...
/*
        РемонтОсновнихЗасобів_Елемент.cs
        Елемент
*/
...
partial class РемонтОсновнихЗасобів_Елемент : DocumentFormElement
{
    ...
    partial void Initialize()
    {
        ...
        CreateDocName(РемонтОсновнихЗасобів_Const.FULLNAME, НомерДок, ДатаДок);
        ...
        CreateField(HBoxComment, "Коментар:", Коментар);
            ...
            //Підстава:
            Підстава.BoundConfType = "Документи.РемонтОсновнихЗасобів.Підстава";
                
    }

    public static РемонтОсновнихЗасобів_Елемент New()
    {
        РемонтОсновнихЗасобів_Елемент element = NewWithProperties([]);
    ...
    {
        CommonForms_DocumentMovementThroughRegisters.Create(new РемонтОсновнихЗасобів_Pointer(uniqueID));
    }
