...
static class РемонтОсновнихЗасобів_Функції
{
    ...
    {
        РемонтОсновнихЗасобів_Objest Обєкт = new();
        if (await Обєкт.Read(uniqueID))
        {
            РемонтОсновнихЗасобів_Objest Новий = await Обєкт.Copy(true);
            await Новий.Save();
    ...
    {
        РемонтОсновнихЗасобів_Objest? Обєкт = await new РемонтОсновнихЗасобів_Pointer(uniqueID).GetDocumentObject(true);
