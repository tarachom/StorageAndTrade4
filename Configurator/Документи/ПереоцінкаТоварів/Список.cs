...
[GObject.Subclass<DocumentFormJournalFull>("List_3m6eAfzZz3ii9eTClJDoA")]
public partial class ПереоцінкаТоварів_Список : DocumentFormJournalFull
{
    ...
    public static ПереоцінкаТоварів_Список New()
    {
        ПереоцінкаТоварів_Список list = NewWithProperties([]);
