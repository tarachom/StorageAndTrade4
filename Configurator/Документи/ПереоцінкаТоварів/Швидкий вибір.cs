...
using ТабличнийСписок = GeneratedCode.Документи.ТабличніСписки.ПереоцінкаТоварів_Записи;
using Функції = StorageAndTrade.ПереоцінкаТоварів_Функції;

namespace StorageAndTrade;

[GObject.Subclass<DocumentFormJournalSmall>("SmallList_3m6eATLaLH2IXcKeTM0rGQ")]
public partial class ПереоцінкаТоварів_ШвидкийВибір : DocumentFormJournalSmall
{
    partial void Initialize()
    {
        TypeName = ПереоцінкаТоварів_Const.POINTER;
        KeyForSetting = ".Small";
        ТабличнийСписок.AddColumn(this);
        SetPagesSettings(50);
    }

    public static ПереоцінкаТоварів_ШвидкийВибір New()
    {
        ПереоцінкаТоварів_ШвидкийВибір list = NewWithProperties([]);
    ...
    {
        foreach (var uid in uniqueID)
            CommonForms_DocumentMovementThroughRegisters.Create(new ПереоцінкаТоварів_Pointer(uid));
    }
