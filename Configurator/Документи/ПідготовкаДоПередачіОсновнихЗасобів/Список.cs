...
[GObject.Subclass<DocumentFormJournalFull>("List_5W6eAXHH6n2GBmrFLYND4w")]
public partial class ПідготовкаДоПередачіОсновнихЗасобів_Список : DocumentFormJournalFull
{
    ...
    public static ПідготовкаДоПередачіОсновнихЗасобів_Список New()
    {
        ПідготовкаДоПередачіОсновнихЗасобів_Список list = NewWithProperties([]);
