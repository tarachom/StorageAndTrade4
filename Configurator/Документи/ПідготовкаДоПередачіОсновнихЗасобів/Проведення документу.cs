...
{
    public static async Task<bool> Spend(ПідготовкаДоПередачіОсновнихЗасобів_Objest ДокументОбєкт)
    {
        try
        {
    ...
    public static Task Clear(ПідготовкаДоПередачіОсновнихЗасобів_Objest ДокументОбєкт)
    {
