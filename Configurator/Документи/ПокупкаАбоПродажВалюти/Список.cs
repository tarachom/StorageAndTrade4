...
[GObject.Subclass<DocumentFormJournalFull>("List_5G6eAWggsXCEH8GAxoM7tA")]
public partial class ПокупкаАбоПродажВалюти_Список : DocumentFormJournalFull
{
    ...
    public static ПокупкаАбоПродажВалюти_Список New()
    {
        ПокупкаАбоПродажВалюти_Список list = NewWithProperties([]);
