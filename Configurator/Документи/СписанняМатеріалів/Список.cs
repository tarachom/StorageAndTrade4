...
[GObject.Subclass<DocumentFormJournalFull>("List_W6eAa2IIniUa3idCIpM7w")]
public partial class СписанняМатеріалів_Список : DocumentFormJournalFull
{
    ...
    public static СписанняМатеріалів_Список New()
    {
        СписанняМатеріалів_Список list = NewWithProperties([]);
