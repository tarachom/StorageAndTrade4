...
[GObject.Subclass<DocumentFormJournalFull>("List_oW6eAR8vmniXOCGqbAGacw")]
public partial class ПереміщенняМатеріалівВЕксплуатації_Список : DocumentFormJournalFull
{
    ...
    public static ПереміщенняМатеріалівВЕксплуатації_Список New()
    {
        ПереміщенняМатеріалівВЕксплуатації_Список list = NewWithProperties([]);
