...
[GObject.Subclass<DocumentFormJournalFull>("List_fubOyszQiEeWJ63xYusv9g")]
public partial class БухгалтерськаОперація_Список : DocumentFormJournalFull
{
    ...
    public static БухгалтерськаОперація_Список New()
    {
        БухгалтерськаОперація_Список list = NewWithProperties([]);
