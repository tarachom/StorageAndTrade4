...
using ТабличнийСписок = GeneratedCode.Документи.ТабличніСписки.ПереоцінкаОсновнихЗасобів_Записи;
using Функції = StorageAndTrade.ПереоцінкаОсновнихЗасобів_Функції;

namespace StorageAndTrade;

[GObject.Subclass<DocumentFormJournalSmall>("SmallList_3m6eAXINkXPnlPlHvPPYg")]
public partial class ПереоцінкаОсновнихЗасобів_ШвидкийВибір : DocumentFormJournalSmall
{
    partial void Initialize()
    {
        TypeName = ПереоцінкаОсновнихЗасобів_Const.POINTER;
        KeyForSetting = ".Small";
        ТабличнийСписок.AddColumn(this);
        SetPagesSettings(50);
    }

    public static ПереоцінкаОсновнихЗасобів_ШвидкийВибір New()
    {
        ПереоцінкаОсновнихЗасобів_ШвидкийВибір list = NewWithProperties([]);
    ...
    {
        foreach (var uid in uniqueID)
            CommonForms_DocumentMovementThroughRegisters.Create(new ПереоцінкаОсновнихЗасобів_Pointer(uid));
    }
