...
[GObject.Subclass<DocumentFormJournalFull>("List_3m6eAT8N4XyUcAE6CNw6Gw")]
public partial class ПереоцінкаОсновнихЗасобів_Список : DocumentFormJournalFull
{
    ...
    public static ПереоцінкаОсновнихЗасобів_Список New()
    {
        ПереоцінкаОсновнихЗасобів_Список list = NewWithProperties([]);
