...
{
    public static async Task<bool> Spend(ЗвітКомітентуПроПродажТоварів_Objest ДокументОбєкт)
    {
        try
        {
    ...
    public static Task Clear(ЗвітКомітентуПроПродажТоварів_Objest ДокументОбєкт)
    {
