...
[GObject.Subclass<DocumentFormJournalSmall>("SmallList_jm6eAQ2Iqni5i5EwzazKHg")]
public partial class ЗвітКомітентуПроПродажТоварів_ШвидкийВибір : DocumentFormJournalSmall
{
    ...
    public static ЗвітКомітентуПроПродажТоварів_ШвидкийВибір New()
    {
        ЗвітКомітентуПроПродажТоварів_ШвидкийВибір list = NewWithProperties([]);
