...
public class РозміщенняТоварівНаСкладі_ШвидкийВибір : DocumentFormJournalSmall
{
    public РозміщенняТоварівНаСкладі_ШвидкийВибір() : base(Program.BasicForm?.NotebookFunc)
    {
