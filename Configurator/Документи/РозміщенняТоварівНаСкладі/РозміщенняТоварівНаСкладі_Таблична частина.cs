...
partial class РозміщенняТоварівНаСкладі_ТабличнаЧастина_Товари : DocumentFormTablePart
{
    ...
    [GObject.Subclass<GObject.Object>("ItemRow_YdAjQsEgqEcpj9SSRLeOA")]
    ...
    public РозміщенняТоварівНаСкладі_ТабличнаЧастина_Товари() : base(Program.BasicForm?.NotebookFunc)
    {
