...
[GObject.Subclass<DocumentFormJournalFull>("List_o26eAUsVm32TkPGkoMUJ4Q")]
public partial class ПередачаНематеріальнихАктивів_Список : DocumentFormJournalFull
{
    ...
    public static ПередачаНематеріальнихАктивів_Список New()
    {
        ПередачаНематеріальнихАктивів_Список list = NewWithProperties([]);
