...
/*     
        ПередачаНематеріальнихАктивів.cs
        Список
*/
...
using ТабличнийСписок = GeneratedCode.Документи.ТабличніСписки.ПередачаНематеріальнихАктивів_Записи;
using Функції = StorageAndTrade.ПередачаНематеріальнихАктивів_Функції;

namespace StorageAndTrade;

[GObject.Subclass<DocumentFormJournalSmall>("SmallList_o26eAX4VPnGT6dHnolYGkg")]
public partial class ПередачаНематеріальнихАктивів_ШвидкийВибір : DocumentFormJournalSmall
{
    partial void Initialize()
    {
        TypeName = ПередачаНематеріальнихАктивів_Const.POINTER;
        KeyForSetting = ".Small";
        ТабличнийСписок.AddColumn(this);
        SetPagesSettings(50);
    }

    public static ПередачаНематеріальнихАктивів_ШвидкийВибір New()
    {
        ПередачаНематеріальнихАктивів_ШвидкийВибір list = NewWithProperties([]);
    ...
    {
        foreach (var uid in uniqueID)
            CommonForms_DocumentMovementThroughRegisters.Create(new ПередачаНематеріальнихАктивів_Pointer(uid));
    }
