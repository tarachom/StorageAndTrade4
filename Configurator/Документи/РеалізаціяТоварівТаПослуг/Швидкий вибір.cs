...
using ТабличнийСписок = GeneratedCode.Документи.ТабличніСписки.РеалізаціяТоварівТаПослуг_Записи;
using Функції = StorageAndTrade.РеалізаціяТоварівТаПослуг_Функції;

namespace StorageAndTrade;

[GObject.Subclass<DocumentFormJournalSmall>("SmallList_RQuE403ue0m5gwvYjY6oLQ")]
public partial class РеалізаціяТоварівТаПослуг_ШвидкийВибір : DocumentFormJournalSmall
{
    partial void Initialize()
    {
        TypeName = РеалізаціяТоварівТаПослуг_Const.POINTER;
        KeyForSetting = ".Small";
        ТабличнийСписок.AddColumn(this);
        SetPagesSettings(50);
    }

    public static РеалізаціяТоварівТаПослуг_ШвидкийВибір New()
    {
        РеалізаціяТоварівТаПослуг_ШвидкийВибір list = NewWithProperties([]);
