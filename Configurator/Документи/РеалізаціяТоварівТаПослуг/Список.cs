...
[GObject.Subclass<DocumentFormJournalFull>("List_sgZ8LUzdF0i0RTJSW39ovA")]
public partial class РеалізаціяТоварівТаПослуг_Список : DocumentFormJournalFull
{
    ...
    public static РеалізаціяТоварівТаПослуг_Список New()
    {
        РеалізаціяТоварівТаПослуг_Список list = NewWithProperties([]);
