...
[GObject.Subclass<DocumentFormJournalFull>("List_3W6eAVExcnaIuipyQlYX4g")]
public partial class ПереоцінкаВалюти_Список : DocumentFormJournalFull
{
    ...
    public static ПереоцінкаВалюти_Список New()
    {
        ПереоцінкаВалюти_Список list = NewWithProperties([]);
