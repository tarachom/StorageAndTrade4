...
static class ПереоцінкаВалюти_Функції
{
    public static List<Where> Відбори(string searchText)
    {
        ...
        [
            ...
            //Назва
            new Where(ПереоцінкаВалюти_Const.Назва, Comparison.LIKE, searchText) { FuncToField = "LOWER" },
                    
            //Коментар
            new Where(Comparison.OR, ПереоцінкаВалюти_Const.Коментар, Comparison.LIKE, searchText) { FuncToField = "LOWER" },
    ...
    {
        ПереоцінкаВалюти_Елемент page = ПереоцінкаВалюти_Елемент.New();
    ...
    {
        ПереоцінкаВалюти_Список page = ПереоцінкаВалюти_Список.New();
        page.DocumentPointerItem = uniqueID;
        page.CallBack_OnSelectPointer = сallBack_OnSelectPointer;

        Program.BasicForm?.NotebookFunc.CreatePage(ПереоцінкаВалюти_Const.FULLNAME, page);
        await page.SetValue();
    }

    public static async Task SetDeletionLabel(UniqueID uniqueID)
    {
        ПереоцінкаВалюти_Pointer Вказівник = new(uniqueID);
