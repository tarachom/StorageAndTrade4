...
[GObject.Subclass<DocumentFormJournalFull>("List_mW6eAewhonqA1nuIbC5ng")]
public partial class НакладнаВимога_Список : DocumentFormJournalFull
{
    ...
    public static НакладнаВимога_Список New()
    {
        НакладнаВимога_Список list = NewWithProperties([]);
