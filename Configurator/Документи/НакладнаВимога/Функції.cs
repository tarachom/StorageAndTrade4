...
static class НакладнаВимога_Функції
{
    ...
    {
        НакладнаВимога_Елемент page = НакладнаВимога_Елемент.New();
    ...
    {
        НакладнаВимога_Список page = НакладнаВимога_Список.New();
        page.DocumentPointerItem = uniqueID;
        page.CallBack_OnSelectPointer = сallBack_OnSelectPointer;

        Program.BasicForm?.NotebookFunc.CreatePage(НакладнаВимога_Const.FULLNAME, page);
        await page.SetValue();
    }

    public static async Task SetDeletionLabel(UniqueID uniqueID)
    {
        НакладнаВимога_Pointer Вказівник = new(uniqueID);
