...
using ТабличнийСписок = GeneratedCode.Документи.ТабличніСписки.НакладнаВимога_Записи;
using Функції = StorageAndTrade.НакладнаВимога_Функції;

namespace StorageAndTrade;

[GObject.Subclass<DocumentFormJournalSmall>("SmallList_mW6eAR0iLXaNvxXWeda6HQ")]
public partial class НакладнаВимога_ШвидкийВибір : DocumentFormJournalSmall
{
    partial void Initialize()
    {
        TypeName = НакладнаВимога_Const.POINTER;
        KeyForSetting = ".Small";
        ТабличнийСписок.AddColumn(this);
        SetPagesSettings(50);
    }

    public static НакладнаВимога_ШвидкийВибір New()
    {
        НакладнаВимога_ШвидкийВибір list = NewWithProperties([]);
    ...
    {
        foreach (var uid in uniqueID)
            CommonForms_DocumentMovementThroughRegisters.Create(new НакладнаВимога_Pointer(uid));
    }
