...
static class Модернізація_Функції
{
    public static List<Where> Відбори(string searchText)
    {
        ...
        [
            ...
            //Назва
            new Where(Модернізація_Const.Назва, Comparison.LIKE, searchText) { FuncToField = "LOWER" },
                    
            //Коментар
            new Where(Comparison.OR, Модернізація_Const.Коментар, Comparison.LIKE, searchText) { FuncToField = "LOWER" },
    ...
    {
        Модернізація_Елемент page = Модернізація_Елемент.New();
    ...
    {
        Модернізація_Список page = Модернізація_Список.New();
        page.DocumentPointerItem = uniqueID;
        page.CallBack_OnSelectPointer = сallBack_OnSelectPointer;

        Program.BasicForm?.NotebookFunc.CreatePage(Модернізація_Const.FULLNAME, page);
        await page.SetValue();
    }

    public static async Task SetDeletionLabel(UniqueID uniqueID)
    {
        Модернізація_Pointer Вказівник = new(uniqueID);
