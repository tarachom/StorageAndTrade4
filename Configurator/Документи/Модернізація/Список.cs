...
[GObject.Subclass<DocumentFormJournalFull>("List_lW6eAZiwpX6u2xMxAlwdUA")]
public partial class Модернізація_Список : DocumentFormJournalFull
{
    ...
    public static Модернізація_Список New()
    {
        Модернізація_Список list = NewWithProperties([]);
