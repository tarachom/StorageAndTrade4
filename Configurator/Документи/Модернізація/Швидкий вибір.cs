...
using ТабличнийСписок = GeneratedCode.Документи.ТабличніСписки.Модернізація_Записи;
using Функції = StorageAndTrade.Модернізація_Функції;

namespace StorageAndTrade;

[GObject.Subclass<DocumentFormJournalSmall>("SmallList_lW6eAcwQHWmH6c0BsKMZg")]
public partial class Модернізація_ШвидкийВибір : DocumentFormJournalSmall
{
    partial void Initialize()
    {
        TypeName = Модернізація_Const.POINTER;
        KeyForSetting = ".Small";
        ТабличнийСписок.AddColumn(this);
        SetPagesSettings(50);
    }

    public static Модернізація_ШвидкийВибір New()
    {
        Модернізація_ШвидкийВибір list = NewWithProperties([]);
    ...
    {
        foreach (var uid in uniqueID)
            CommonForms_DocumentMovementThroughRegisters.Create(new Модернізація_Pointer(uid));
    }
