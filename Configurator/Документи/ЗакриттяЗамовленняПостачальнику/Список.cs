...
[GObject.Subclass<DocumentFormJournalFull>("List_gk9CAugaC0GluMOUD1fUMQ")]
public partial class ЗакриттяЗамовленняПостачальнику_Список : DocumentFormJournalFull
{
    ...
    public static ЗакриттяЗамовленняПостачальнику_Список New()
    {
        ЗакриттяЗамовленняПостачальнику_Список list = NewWithProperties([]);
