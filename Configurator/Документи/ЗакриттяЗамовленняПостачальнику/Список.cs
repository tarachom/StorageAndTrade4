...
public class ЗакриттяЗамовленняПостачальнику_Список : DocumentFormJournalFull
{
    public ЗакриттяЗамовленняПостачальнику_Список() : base(Program.BasicForm?.NotebookFunc)
    {
