...
public class ЗакриттяЗамовленняПостачальнику_ШвидкийВибір : DocumentFormJournalSmall
{
    public ЗакриттяЗамовленняПостачальнику_ШвидкийВибір() : base(Program.BasicForm?.NotebookFunc)
    {
