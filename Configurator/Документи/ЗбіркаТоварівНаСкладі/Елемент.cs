...
class ЗбіркаТоварівНаСкладі_Елемент : DocumentFormElement
{
    ...
    #region TabularParts
        ...
        ЗбіркаТоварівНаСкладі_ТабличнаЧастина_Товари Товари = new() { WidthRequest = 500, HeightRequest = 300 };
    
    #endregion

    public ЗбіркаТоварівНаСкладі_Елемент() : base(Program.BasicForm?.NotebookFunc)
    {
        Element = Елемент;
