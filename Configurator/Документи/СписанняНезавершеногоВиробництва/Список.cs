...
[GObject.Subclass<DocumentFormJournalFull>("List_m6eAf42any4GtGdGe5V0A")]
public partial class СписанняНезавершеногоВиробництва_Список : DocumentFormJournalFull
{
    ...
    public static СписанняНезавершеногоВиробництва_Список New()
    {
        СписанняНезавершеногоВиробництва_Список list = NewWithProperties([]);
