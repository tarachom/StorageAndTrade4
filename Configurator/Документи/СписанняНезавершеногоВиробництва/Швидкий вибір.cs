...
/*     
        СписанняНезавершеногоВиробництва.cs
        Список
*/
...
using ТабличнийСписок = GeneratedCode.Документи.ТабличніСписки.СписанняНезавершеногоВиробництва_Записи;
using Функції = StorageAndTrade.СписанняНезавершеногоВиробництва_Функції;

namespace StorageAndTrade;

[GObject.Subclass<DocumentFormJournalSmall>("SmallList_m6eATM3snacuwgw9B3k4Q")]
public partial class СписанняНезавершеногоВиробництва_ШвидкийВибір : DocumentFormJournalSmall
{
    partial void Initialize()
    {
        TypeName = СписанняНезавершеногоВиробництва_Const.POINTER;
        KeyForSetting = ".Small";
        ТабличнийСписок.AddColumn(this);
        SetPagesSettings(50);
    }

    public static СписанняНезавершеногоВиробництва_ШвидкийВибір New()
    {
        СписанняНезавершеногоВиробництва_ШвидкийВибір list = NewWithProperties([]);
    ...
    {
        foreach (var uid in uniqueID)
            CommonForms_DocumentMovementThroughRegisters.Create(new СписанняНезавершеногоВиробництва_Pointer(uid));
    }
