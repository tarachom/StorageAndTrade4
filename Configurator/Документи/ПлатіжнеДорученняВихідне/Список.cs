...
[GObject.Subclass<DocumentFormJournalFull>("List_4W6eAe6To3Odz70fu4dRVQ")]
public partial class ПлатіжнеДорученняВихідне_Список : DocumentFormJournalFull
{
    ...
    public static ПлатіжнеДорученняВихідне_Список New()
    {
        ПлатіжнеДорученняВихідне_Список list = NewWithProperties([]);
