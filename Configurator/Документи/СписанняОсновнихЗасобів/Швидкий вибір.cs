...
using ТабличнийСписок = GeneratedCode.Документи.ТабличніСписки.СписанняОсновнихЗасобів_Записи;
using Функції = StorageAndTrade.СписанняОсновнихЗасобів_Функції;

namespace StorageAndTrade;

[GObject.Subclass<DocumentFormJournalSmall>("SmallList_G6eAS6T36G85TtbU5aLA")]
public partial class СписанняОсновнихЗасобів_ШвидкийВибір : DocumentFormJournalSmall
{
    partial void Initialize()
    {
        TypeName = СписанняОсновнихЗасобів_Const.POINTER;
        KeyForSetting = ".Small";
        ТабличнийСписок.AddColumn(this);
        SetPagesSettings(50);
    }

    public static СписанняОсновнихЗасобів_ШвидкийВибір New()
    {
        СписанняОсновнихЗасобів_ШвидкийВибір list = NewWithProperties([]);
    ...
    {
        foreach (var uid in uniqueID)
            CommonForms_DocumentMovementThroughRegisters.Create(new СписанняОсновнихЗасобів_Pointer(uid));
    }
