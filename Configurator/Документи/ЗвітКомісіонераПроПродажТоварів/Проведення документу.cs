...
{
    public static async Task<bool> Spend(ЗвітКомісіонераПроПродажТоварів_Object ДокументОбєкт)
    {
        try
        {
    ...
    public static Task Clear(ЗвітКомісіонераПроПродажТоварів_Object ДокументОбєкт)
    {
