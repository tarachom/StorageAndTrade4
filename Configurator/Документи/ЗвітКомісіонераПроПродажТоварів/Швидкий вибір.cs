...
[GObject.Subclass<DocumentFormJournalSmall>("SmallList_da1lkJyZEu8sNF8JRiO6A")]
public partial class ЗвітКомісіонераПроПродажТоварів_ШвидкийВибір : DocumentFormJournalSmall
{
    ...
    public static ЗвітКомісіонераПроПродажТоварів_ШвидкийВибір New()
    {
        ЗвітКомісіонераПроПродажТоварів_ШвидкийВибір list = NewWithProperties([]);
