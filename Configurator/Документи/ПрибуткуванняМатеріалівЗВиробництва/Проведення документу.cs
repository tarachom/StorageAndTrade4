...
{
    public static async Task<bool> Spend(ПрибуткуванняМатеріалівЗВиробництва_Object ДокументОбєкт)
    {
        try
        {
    ...
    public static Task Clear(ПрибуткуванняМатеріалівЗВиробництва_Object ДокументОбєкт)
    {
