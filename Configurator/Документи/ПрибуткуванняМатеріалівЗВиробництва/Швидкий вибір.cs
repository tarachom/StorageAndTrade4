...
/*     
        ПрибуткуванняМатеріалівЗВиробництва.cs
        Список
*/
...
using ТабличнийСписок = GeneratedCode.Документи.ТабличніСписки.ПрибуткуванняМатеріалівЗВиробництва_Записи;
using Функції = StorageAndTrade.ПрибуткуванняМатеріалівЗВиробництва_Функції;

namespace StorageAndTrade;

[GObject.Subclass<DocumentFormJournalSmall>("SmallList_6G6eAbCV6nGsGiEweXoIg")]
public partial class ПрибуткуванняМатеріалівЗВиробництва_ШвидкийВибір : DocumentFormJournalSmall
{
    partial void Initialize()
    {
        TypeName = ПрибуткуванняМатеріалівЗВиробництва_Const.POINTER;
        KeyForSetting = ".Small";
        ТабличнийСписок.AddColumn(this);
        SetPagesSettings(50);
    }

    public static ПрибуткуванняМатеріалівЗВиробництва_ШвидкийВибір New()
    {
        ПрибуткуванняМатеріалівЗВиробництва_ШвидкийВибір list = NewWithProperties([]);
    ...
    {
        foreach (var uid in uniqueID)
            CommonForms_DocumentMovementThroughRegisters.Create(new ПрибуткуванняМатеріалівЗВиробництва_Pointer(uid));
    }
