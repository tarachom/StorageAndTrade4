...
[GObject.Subclass<DocumentFormJournalFull>("List_6G6eAX6V7HGEvjfPRGQqWA")]
public partial class ПрибуткуванняМатеріалівЗВиробництва_Список : DocumentFormJournalFull
{
    ...
    public static ПрибуткуванняМатеріалівЗВиробництва_Список New()
    {
        ПрибуткуванняМатеріалівЗВиробництва_Список list = NewWithProperties([]);
