...
[GObject.Subclass<DocumentFormJournalFull>("List_l26eAbGz5XGHGN3FjVJxdA")]
public partial class Комплектація_Список : DocumentFormJournalFull
{
    ...
    public static Комплектація_Список New()
    {
        Комплектація_Список list = NewWithProperties([]);
