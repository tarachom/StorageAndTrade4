...
class ЗакриттяЗамовленняКлієнта_ТабличнаЧастина_Товари : DocumentFormTablePart
{
    ...
    public ЗакриттяЗамовленняКлієнта_ТабличнаЧастина_Товари() : base(Program.BasicForm?.NotebookFunc)
    {
