...
public class ЗакриттяЗамовленняКлієнта_ШвидкийВибір : DocumentFormJournalSmall
{
    public ЗакриттяЗамовленняКлієнта_ШвидкийВибір() : base(Program.BasicForm?.NotebookFunc)
    {
