...
/*     
        ПереміщенняНематеріальнихАктивів.cs
        Список
*/
...
using ТабличнийСписок = GeneratedCode.Документи.ТабличніСписки.ПереміщенняНематеріальнихАктивів_Записи;
using Функції = StorageAndTrade.ПереміщенняНематеріальнихАктивів_Функції;

namespace StorageAndTrade;

[GObject.Subclass<DocumentFormJournalSmall>("SmallList_pG6eAZc3i3yLferGUG3H6Q")]
public partial class ПереміщенняНематеріальнихАктивів_ШвидкийВибір : DocumentFormJournalSmall
{
    partial void Initialize()
    {
        TypeName = ПереміщенняНематеріальнихАктивів_Const.POINTER;
        KeyForSetting = ".Small";
        ТабличнийСписок.AddColumn(this);
        SetPagesSettings(50);
    }

    public static ПереміщенняНематеріальнихАктивів_ШвидкийВибір New()
    {
        ПереміщенняНематеріальнихАктивів_ШвидкийВибір list = NewWithProperties([]);
    ...
    {
        foreach (var uid in uniqueID)
            CommonForms_DocumentMovementThroughRegisters.Create(new ПереміщенняНематеріальнихАктивів_Pointer(uid));
    }
