...
[GObject.Subclass<DocumentFormJournalFull>("List_pG6eAV43HWzb9B4XylvrQ")]
public partial class ПереміщенняНематеріальнихАктивів_Список : DocumentFormJournalFull
{
    ...
    public static ПереміщенняНематеріальнихАктивів_Список New()
    {
        ПереміщенняНематеріальнихАктивів_Список list = NewWithProperties([]);
