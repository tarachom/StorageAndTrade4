...
using ТабличнийСписок = GeneratedCode.Документи.ТабличніСписки.ПрихіднийКасовийОрдер_Записи;
using Функції = StorageAndTrade.ПрихіднийКасовийОрдер_Функції;

namespace StorageAndTrade;

[GObject.Subclass<DocumentFormJournalSmall>("SmallList_7qfDMiiKRkaSzk9JQmvdgA")]
public partial class ПрихіднийКасовийОрдер_ШвидкийВибір : DocumentFormJournalSmall
{
    ...
    public static ПрихіднийКасовийОрдер_ШвидкийВибір New()
    {
        ПрихіднийКасовийОрдер_ШвидкийВибір list = NewWithProperties([]);
    ...
    protected override void ReportSpendTheDocument(UniqueID[] uniqueID)
    {
        foreach (var uid in uniqueID)
            CommonForms_DocumentMovementThroughRegisters.Create(new ПрихіднийКасовийОрдер_Pointer(uid));
    }
