...
[GObject.Subclass<DocumentFormJournalFull>("List_626eAd573mDO3V0T6ZTQ")]
public partial class ПрибуткуванняТоварівЗПереробки_Список : DocumentFormJournalFull
{
    ...
    public static ПрибуткуванняТоварівЗПереробки_Список New()
    {
        ПрибуткуванняТоварівЗПереробки_Список list = NewWithProperties([]);
