...
/*     
        ПрибуткуванняТоварівЗПереробки.cs
        Список
*/
...
using ТабличнийСписок = GeneratedCode.Документи.ТабличніСписки.ПрибуткуванняТоварівЗПереробки_Записи;
using Функції = StorageAndTrade.ПрибуткуванняТоварівЗПереробки_Функції;

namespace StorageAndTrade;

[GObject.Subclass<DocumentFormJournalSmall>("SmallList_626eAQ98i3WdLU1giXPQ")]
public partial class ПрибуткуванняТоварівЗПереробки_ШвидкийВибір : DocumentFormJournalSmall
{
    partial void Initialize()
    {
        TypeName = ПрибуткуванняТоварівЗПереробки_Const.POINTER;
        KeyForSetting = ".Small";
        ТабличнийСписок.AddColumn(this);
        SetPagesSettings(50);
    }

    public static ПрибуткуванняТоварівЗПереробки_ШвидкийВибір New()
    {
        ПрибуткуванняТоварівЗПереробки_ШвидкийВибір list = NewWithProperties([]);
    ...
    {
        foreach (var uid in uniqueID)
            CommonForms_DocumentMovementThroughRegisters.Create(new ПрибуткуванняТоварівЗПереробки_Pointer(uid));
    }
