...
[GObject.Subclass<DocumentFormJournalFull>("List_7W6eAQUWFHKeWOB8nB9OIQ")]
public partial class ПрийняттяДоОбліку_Список : DocumentFormJournalFull
{
    ...
    public static ПрийняттяДоОбліку_Список New()
    {
        ПрийняттяДоОбліку_Список list = NewWithProperties([]);
