...
static class ПрийняттяДоОбліку_Функції
{
    public static List<Where> Відбори(string searchText)
    {
        ...
        [
            ...
            //Назва
            new Where(ПрийняттяДоОбліку_Const.Назва, Comparison.LIKE, searchText) { FuncToField = "LOWER" },
                    
            //Коментар
            new Where(Comparison.OR, ПрийняттяДоОбліку_Const.Коментар, Comparison.LIKE, searchText) { FuncToField = "LOWER" },
    ...
    {
        ПрийняттяДоОбліку_Елемент page = ПрийняттяДоОбліку_Елемент.New();
    ...
    {
        ПрийняттяДоОбліку_Список page = ПрийняттяДоОбліку_Список.New();
        page.DocumentPointerItem = uniqueID;
        page.CallBack_OnSelectPointer = сallBack_OnSelectPointer;

        Program.BasicForm?.NotebookFunc.CreatePage(ПрийняттяДоОбліку_Const.FULLNAME, page);
        await page.SetValue();
    }

    public static async Task SetDeletionLabel(UniqueID uniqueID)
    {
        ПрийняттяДоОбліку_Pointer Вказівник = new(uniqueID);
