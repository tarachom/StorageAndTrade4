...
public class ВнутрішнєСпоживанняТоварів_ШвидкийВибір : DocumentFormJournalSmall
{
    public ВнутрішнєСпоживанняТоварів_ШвидкийВибір() : base(Program.BasicForm?.NotebookFunc)
    {
