...
using ТабличнийСписок = GeneratedCode.Документи.ТабличніСписки.ЗаписКнигиПридбання_Записи;
using Функції = StorageAndTrade.ЗаписКнигиПридбання_Функції;

namespace StorageAndTrade;

[GObject.Subclass<DocumentFormJournalSmall>("SmallList_rVXMxaugkWFAXJBFLBUhw")]
public partial class ЗаписКнигиПридбання_ШвидкийВибір : DocumentFormJournalSmall
{
    partial void Initialize()
    {
        TypeName = ЗаписКнигиПридбання_Const.POINTER;
        KeyForSetting = ".Small";
        ТабличнийСписок.AddColumn(this);
        SetPagesSettings(50);
    }

    public static ЗаписКнигиПридбання_ШвидкийВибір New()
    {
        ЗаписКнигиПридбання_ШвидкийВибір list = NewWithProperties([]);
    ...
    {
        foreach (var uid in uniqueID)
            CommonForms_DocumentMovementThroughRegisters.Create(new ЗаписКнигиПридбання_Pointer(uid));
    }
