...
{
    public static async Task<bool> Spend(ПослугиСторонньоїОрганізації_Objest ДокументОбєкт)
    {
        try
        {
    ...
    public static Task Clear(ПослугиСторонньоїОрганізації_Objest ДокументОбєкт)
    {
