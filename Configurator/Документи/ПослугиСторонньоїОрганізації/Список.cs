...
[GObject.Subclass<DocumentFormJournalFull>("List_5m6eAY6WnCJSHnpP4w2Sw")]
public partial class ПослугиСторонньоїОрганізації_Список : DocumentFormJournalFull
{
    ...
    public static ПослугиСторонньоїОрганізації_Список New()
    {
        ПослугиСторонньоїОрганізації_Список list = NewWithProperties([]);
