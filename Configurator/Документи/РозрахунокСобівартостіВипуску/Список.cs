...
[GObject.Subclass<DocumentFormJournalFull>("List_G6eASzoVXaFMPeH4OxEBA")]
public partial class РозрахунокСобівартостіВипуску_Список : DocumentFormJournalFull
{
    ...
    public static РозрахунокСобівартостіВипуску_Список New()
    {
        РозрахунокСобівартостіВипуску_Список list = NewWithProperties([]);
