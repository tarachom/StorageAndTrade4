...
/*     
        РозрахунокСобівартостіВипуску.cs
        Список
*/
...
using ТабличнийСписок = GeneratedCode.Документи.ТабличніСписки.РозрахунокСобівартостіВипуску_Записи;
using Функції = StorageAndTrade.РозрахунокСобівартостіВипуску_Функції;

namespace StorageAndTrade;

[GObject.Subclass<DocumentFormJournalSmall>("SmallList_G6eAWLoY32FYjt3Nu2e2g")]
public partial class РозрахунокСобівартостіВипуску_ШвидкийВибір : DocumentFormJournalSmall
{
    partial void Initialize()
    {
        TypeName = РозрахунокСобівартостіВипуску_Const.POINTER;
        KeyForSetting = ".Small";
        ТабличнийСписок.AddColumn(this);
        SetPagesSettings(50);
    }

    public static РозрахунокСобівартостіВипуску_ШвидкийВибір New()
    {
        РозрахунокСобівартостіВипуску_ШвидкийВибір list = NewWithProperties([]);
    ...
    {
        foreach (var uid in uniqueID)
            CommonForms_DocumentMovementThroughRegisters.Create(new РозрахунокСобівартостіВипуску_Pointer(uid));
    }
