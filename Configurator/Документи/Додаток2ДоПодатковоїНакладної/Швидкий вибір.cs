...
[GObject.Subclass<DocumentFormJournalSmall>("SmallList_n24Ny9WmF0qn7ognXzIA")]
public partial class Додаток2ДоПодатковоїНакладної_ШвидкийВибір : DocumentFormJournalSmall
{
    ...
    public static Додаток2ДоПодатковоїНакладної_ШвидкийВибір New()
    {
        Додаток2ДоПодатковоїНакладної_ШвидкийВибір list = NewWithProperties([]);
