...
/*     
        ЗмінаПараметрівОсновнихЗасобів.cs
        Список
*/
...
using ТабличнийСписок = GeneratedCode.Документи.ТабличніСписки.ЗмінаПараметрівОсновнихЗасобів_Записи;
using Функції = StorageAndTrade.ЗмінаПараметрівОсновнихЗасобів_Функції;

namespace StorageAndTrade;

[GObject.Subclass<DocumentFormJournalSmall>("SmallList_ktftDxeaLUmb6GIERiXPg")]
public partial class ЗмінаПараметрівОсновнихЗасобів_ШвидкийВибір : DocumentFormJournalSmall
{
    partial void Initialize()
    {
        TypeName = ЗмінаПараметрівОсновнихЗасобів_Const.POINTER;
        KeyForSetting = ".Small";
        ТабличнийСписок.AddColumn(this);
        SetPagesSettings(50);
    }

    public static ЗмінаПараметрівОсновнихЗасобів_ШвидкийВибір New()
    {
        ЗмінаПараметрівОсновнихЗасобів_ШвидкийВибір list = NewWithProperties([]);
    ...
    {
        foreach (var uid in uniqueID)
            CommonForms_DocumentMovementThroughRegisters.Create(new ЗмінаПараметрівОсновнихЗасобів_Pointer(uid));
    }
