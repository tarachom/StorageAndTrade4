...
[GObject.Subclass<DocumentFormJournalFull>("List_yVsW1n29LU2quZoW8GCCUQ")]
public partial class ЗмінаПараметрівОсновнихЗасобів_Список : DocumentFormJournalFull
{
    ...
    public static ЗмінаПараметрівОсновнихЗасобів_Список New()
    {
        ЗмінаПараметрівОсновнихЗасобів_Список list = NewWithProperties([]);
