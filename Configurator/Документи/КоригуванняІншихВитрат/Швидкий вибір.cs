...
using ТабличнийСписок = GeneratedCode.Документи.ТабличніСписки.КоригуванняІншихВитрат_Записи;
using Функції = StorageAndTrade.КоригуванняІншихВитрат_Функції;

namespace StorageAndTrade;

[GObject.Subclass<DocumentFormJournalSmall>("SmallList_lG6eARvbHnewIJWKJjBqw")]
public partial class КоригуванняІншихВитрат_ШвидкийВибір : DocumentFormJournalSmall
{
    partial void Initialize()
    {
        TypeName = КоригуванняІншихВитрат_Const.POINTER;
        KeyForSetting = ".Small";
        ТабличнийСписок.AddColumn(this);
        SetPagesSettings(50);
    }

    public static КоригуванняІншихВитрат_ШвидкийВибір New()
    {
        КоригуванняІншихВитрат_ШвидкийВибір list = NewWithProperties([]);
    ...
    {
        foreach (var uid in uniqueID)
            CommonForms_DocumentMovementThroughRegisters.Create(new КоригуванняІншихВитрат_Pointer(uid));
    }
