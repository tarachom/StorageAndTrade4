...
public class РозміщенняНоменклатуриПоКоміркам_PointerTablePartCell : PointerTablePartCell
{
    ...
    {
        Pointer = new РозміщенняНоменклатуриПоКоміркам_Pointer(p ?? new UnigueID());
