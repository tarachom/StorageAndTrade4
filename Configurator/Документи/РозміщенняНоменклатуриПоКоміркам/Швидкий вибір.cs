...
public class РозміщенняНоменклатуриПоКоміркам_ШвидкийВибір : DocumentFormJournalSmall
{
    public РозміщенняНоменклатуриПоКоміркам_ШвидкийВибір() : base(Program.BasicForm?.NotebookFunc)
    {
