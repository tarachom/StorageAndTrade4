...
public class РозміщенняНоменклатуриПоКоміркам_Список : DocumentFormJournalFull
{
    public РозміщенняНоменклатуриПоКоміркам_Список() : base(Program.BasicForm?.NotebookFunc)
    {
