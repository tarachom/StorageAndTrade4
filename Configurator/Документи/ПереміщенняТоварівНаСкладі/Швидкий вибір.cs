...
public class ПереміщенняТоварівНаСкладі_ШвидкийВибір : DocumentFormJournalSmall
{
    public ПереміщенняТоварівНаСкладі_ШвидкийВибір() : base(Program.BasicForm?.NotebookFunc)
    {
