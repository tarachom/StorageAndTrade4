...
[GObject.Subclass<DocumentFormJournalFull>("List_K4njQ8gfk0CIQGz7HgH0kQ")]
public partial class ПереміщенняТоварівНаСкладі_Список : DocumentFormJournalFull
{
    ...
    public static ПереміщенняТоварівНаСкладі_Список New()
    {
        ПереміщенняТоварівНаСкладі_Список list = NewWithProperties([]);
