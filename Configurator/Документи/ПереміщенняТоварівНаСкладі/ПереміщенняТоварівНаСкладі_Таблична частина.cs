...
partial class ПереміщенняТоварівНаСкладі_ТабличнаЧастина_Товари : DocumentFormTablePart
{
    ...
    [GObject.Subclass<GObject.Object>("ItemRow_UNDsYDE5xUChQT0mOySJew")]
    public partial class ItemRow : IRowSubclassTablePart
    {
        ...
        public Action? Сhanged_КоміркаВідправник;
        ...
        public Action? Сhanged_КоміркаОтримувач;
        ...
        */
        ...
        public GObject.Object Copy()
        {
            ...
            itemRow.КоміркаВідправник = КоміркаВідправник.Copy();
            itemRow.КоміркаОтримувач = КоміркаОтримувач.Copy();
    ...
    public ПереміщенняТоварівНаСкладі_ТабличнаЧастина_Товари() : base(Program.BasicForm?.NotebookFunc)
    {
