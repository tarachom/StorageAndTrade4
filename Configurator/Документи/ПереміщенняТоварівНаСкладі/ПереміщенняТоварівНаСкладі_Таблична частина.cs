...
class ПереміщенняТоварівНаСкладі_ТабличнаЧастина_Товари : DocumentFormTablePart
{
        ...
        */
        ...
        public override ItemRow Copy()
        {
            return new()
            {
                ...
                Кількість = Кількість,
                КоміркаВідправник = КоміркаВідправник.Copy(),
                КоміркаОтримувач = КоміркаОтримувач.Copy(),
