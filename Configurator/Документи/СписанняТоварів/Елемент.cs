...
partial class СписанняТоварів_Елемент : DocumentFormElement
{
    ...
    partial void Initialize()
    {
        ...
        CreateDocName(СписанняТоварів_Const.FULLNAME, НомерДок, ДатаДок);
    ...
    public static СписанняТоварів_Елемент New()
    {
        СписанняТоварів_Елемент element = NewWithProperties([]);
    ...
    {
        CommonForms_DocumentMovementThroughRegisters.Create(new СписанняТоварів_Pointer(uniqueID));
    }
