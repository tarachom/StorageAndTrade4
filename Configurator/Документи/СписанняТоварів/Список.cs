...
[GObject.Subclass<DocumentFormJournalFull>("List_m6eAaFRXeJ8klOPIcIQ")]
public partial class СписанняТоварів_Список : DocumentFormJournalFull
{
    ...
    public static СписанняТоварів_Список New()
    {
        СписанняТоварів_Список list = NewWithProperties([]);
