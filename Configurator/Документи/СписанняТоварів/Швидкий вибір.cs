...
using ТабличнийСписок = GeneratedCode.Документи.ТабличніСписки.СписанняТоварів_Записи;
using Функції = StorageAndTrade.СписанняТоварів_Функції;

namespace StorageAndTrade;

[GObject.Subclass<DocumentFormJournalSmall>("SmallList_m6eAdlznGG1ysnDZvz7w")]
public partial class СписанняТоварів_ШвидкийВибір : DocumentFormJournalSmall
{
    partial void Initialize()
    {
        TypeName = СписанняТоварів_Const.POINTER;
        KeyForSetting = ".Small";
        ТабличнийСписок.AddColumn(this);
        SetPagesSettings(50);
    }

    public static СписанняТоварів_ШвидкийВибір New()
    {
        СписанняТоварів_ШвидкийВибір list = NewWithProperties([]);
    ...
    {
        foreach (var uid in uniqueID)
            CommonForms_DocumentMovementThroughRegisters.Create(new СписанняТоварів_Pointer(uid));
    }
