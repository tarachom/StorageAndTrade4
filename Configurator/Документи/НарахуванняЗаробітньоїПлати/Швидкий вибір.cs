...
/*     
        НарахуванняЗаробітньоїПлати.cs
        Список
*/
...
using ТабличнийСписок = GeneratedCode.Документи.ТабличніСписки.НарахуванняЗаробітньоїПлати_Записи;
using Функції = StorageAndTrade.НарахуванняЗаробітньоїПлати_Функції;

namespace StorageAndTrade;

[GObject.Subclass<DocumentFormJournalSmall>("SmallList_nm6eAdcoLHgg2eXocXhw")]
public partial class НарахуванняЗаробітньоїПлати_ШвидкийВибір : DocumentFormJournalSmall
{
    partial void Initialize()
    {
        TypeName = НарахуванняЗаробітньоїПлати_Const.POINTER;
        KeyForSetting = ".Small";
        ТабличнийСписок.AddColumn(this);
        SetPagesSettings(50);
    }

    public static НарахуванняЗаробітньоїПлати_ШвидкийВибір New()
    {
        НарахуванняЗаробітньоїПлати_ШвидкийВибір list = NewWithProperties([]);
    ...
    {
        foreach (var uid in uniqueID)
            CommonForms_DocumentMovementThroughRegisters.Create(new НарахуванняЗаробітньоїПлати_Pointer(uid));
    }
