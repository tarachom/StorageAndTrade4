...
[GObject.Subclass<DocumentFormJournalFull>("List_nm6eAaUo1HupPC3IvEuUtg")]
public partial class НарахуванняЗаробітньоїПлати_Список : DocumentFormJournalFull
{
    ...
    public static НарахуванняЗаробітньоїПлати_Список New()
    {
        НарахуванняЗаробітньоїПлати_Список list = NewWithProperties([]);
