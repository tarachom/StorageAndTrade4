...
public class ЗакриттяРахункуФактури_ШвидкийВибір : DocumentFormJournalSmall
{
    public ЗакриттяРахункуФактури_ШвидкийВибір() : base(Program.BasicForm?.NotebookFunc)
    {
