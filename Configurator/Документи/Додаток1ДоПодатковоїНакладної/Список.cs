...
[GObject.Subclass<DocumentFormJournalFull>("List_Vz30yLRlhUWj9Us8mVtuyw")]
public partial class Додаток1ДоПодатковоїНакладної_Список : DocumentFormJournalFull
{
    ...
    public static Додаток1ДоПодатковоїНакладної_Список New()
    {
        Додаток1ДоПодатковоїНакладної_Список list = NewWithProperties([]);
