...
{
    public static async Task<bool> Spend(ПрибуткуванняНезавершеногоВиробництва_Objest ДокументОбєкт)
    {
        try
        {
    ...
    public static Task Clear(ПрибуткуванняНезавершеногоВиробництва_Objest ДокументОбєкт)
    {
