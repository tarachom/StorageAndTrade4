...
/*     
        ПрибуткуванняНезавершеногоВиробництва.cs
        Список
*/
...
using ТабличнийСписок = GeneratedCode.Документи.ТабличніСписки.ПрибуткуванняНезавершеногоВиробництва_Записи;
using Функції = StorageAndTrade.ПрибуткуванняНезавершеногоВиробництва_Функції;

namespace StorageAndTrade;

[GObject.Subclass<DocumentFormJournalFull>("List_7G6eAdt293iRKcUErGqU7g")]
public partial class ПрибуткуванняНезавершеногоВиробництва_Список : DocumentFormJournalFull
{
    partial void Initialize()
    {
        TypeName = ПрибуткуванняНезавершеногоВиробництва_Const.POINTER;
        ТабличнийСписок.AddColumn(this);
        SetPagesSettings(50, Pages.StartingPosition.End);
    }

    public static ПрибуткуванняНезавершеногоВиробництва_Список New()
    {
        ПрибуткуванняНезавершеногоВиробництва_Список list = NewWithProperties([]);
    ...
    {
        foreach (var uid in uniqueID)
            CommonForms_DocumentMovementThroughRegisters.Create(new ПрибуткуванняНезавершеногоВиробництва_Pointer(uid));
    }
