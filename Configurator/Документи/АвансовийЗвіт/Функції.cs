...
static class АвансовийЗвіт_Функції
{
    public static List<Where> Відбори(string searchText)
    {
        ...
        [
            ...
            //НомерДок
            new Where(Comparison.OR, АвансовийЗвіт_Const.НомерДок, Comparison.LIKE, searchText) { FuncToField = "LOWER" },
    ...
    {
        АвансовийЗвіт_Елемент page = АвансовийЗвіт_Елемент.New();
    ...
    {
        АвансовийЗвіт_Список page = АвансовийЗвіт_Список.New();
        page.DocumentPointerItem = uniqueID;
        page.CallBack_OnSelectPointer = сallBack_OnSelectPointer;

        Program.BasicForm?.NotebookFunc.CreatePage(АвансовийЗвіт_Const.FULLNAME, page);
        await page.SetValue();
    }

    public static async Task SetDeletionLabel(UniqueID uniqueID)
    {
        АвансовийЗвіт_Pointer Вказівник = new(uniqueID);
