...
using ТабличнийСписок = GeneratedCode.Документи.ТабличніСписки.АвансовийЗвіт_Записи;
using Функції = StorageAndTrade.АвансовийЗвіт_Функції;

namespace StorageAndTrade;

[GObject.Subclass<DocumentFormJournalSmall>("SmallList_basv6mUmp0ydqDZJagvS1A")]
public partial class АвансовийЗвіт_ШвидкийВибір : DocumentFormJournalSmall
{
    partial void Initialize()
    {
        TypeName = АвансовийЗвіт_Const.POINTER;
        KeyForSetting = ".Small";
        ТабличнийСписок.AddColumn(this);
        SetPagesSettings(50);
    }

    public static АвансовийЗвіт_ШвидкийВибір New()
    {
        АвансовийЗвіт_ШвидкийВибір list = NewWithProperties([]);
    ...
    {
        foreach (var uid in uniqueID)
            CommonForms_DocumentMovementThroughRegisters.Create(new АвансовийЗвіт_Pointer(uid));
    }
