...
using ТабличнийСписок = GeneratedCode.Довідники.ТабличніСписки.ПланРахунків_Записи;
using Функції = StorageAndTrade.ПланРахунків_Функції;

namespace StorageAndTrade;

[GObject.Subclass<DirectoryFormJournalSmallTree>("SmallList_JiKtHycEWoWOksmhD7A")]
partial class ПланРахунків_ШвидкийВибір : DirectoryFormJournalSmallTree
{
    partial void Initialize()
    {
        TypeName = ПланРахунків_Const.POINTER;
        KeyForSetting = ".Small";
        ТабличнийСписок.AddColumn(this);
        SetPagesSettings(50);
    }

    public static ПланРахунків_ШвидкийВибір New()
    {
        ПланРахунків_ШвидкийВибір list = NewWithProperties([]);
