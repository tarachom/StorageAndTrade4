...
static class ТипиБухОперацій_Функції
{
    public static List<Where> Відбори(string searchText)
    {
        ...
        [
            ...
            //Код
            new Where(ТипиБухОперацій_Const.Код, Comparison.LIKE, searchText) { FuncToField = "LOWER" },
                    
            //Назва
            new Where(Comparison.OR, ТипиБухОперацій_Const.Назва, Comparison.LIKE, searchText) { FuncToField = "LOWER" },
    ...
    {
        ТипиБухОперацій_Елемент page = ТипиБухОперацій_Елемент.New();
    ...
    public static async ValueTask OpenPageList(UniqueID? uniqueID = null, ConfigurationDirectories.HierarchicalContentType? allowedContentSelection = null, UniqueID? openFolder = null,
        Action<UniqueID>? сallBack_OnSelectPointer = null)
    {
        ТипиБухОперацій_Список page = ТипиБухОперацій_Список.New();
        ...
        Program.BasicForm?.NotebookFunc.CreatePage(ТипиБухОперацій_Const.FULLNAME, page);
        await page.SetValue();
    }

    public static async ValueTask SetDeletionLabel(UniqueID uniqueID)
    {
        ТипиБухОперацій_Pointer Вказівник = new(uniqueID);
