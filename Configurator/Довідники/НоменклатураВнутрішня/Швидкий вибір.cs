...
/*     
        НоменклатураВнутрішня_ШвидкийВибір.cs
        ШвидкийВибір
*/
...
[GObject.Subclass<DirectoryFormJournalSmall>("SmallList_dEF4WFw2fkKdso3oto3v4w")]
partial class НоменклатураВнутрішня_ШвидкийВибір : DirectoryFormJournalSmall
{
    ...
    public static НоменклатураВнутрішня_ШвидкийВибір New()
    {
        НоменклатураВнутрішня_ШвидкийВибір list = NewWithProperties([]);
