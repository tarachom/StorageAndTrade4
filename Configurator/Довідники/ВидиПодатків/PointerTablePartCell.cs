...
/*     
        ВидиПодатків_PointerTablePartCell.cs
...
[GObject.Subclass<PointerTablePartCell>("PointerTablePartCell_dG5YG4irf0evQWhZH5ercQ")]
public partial class ВидиПодатків_PointerTablePartCell : PointerTablePartCell
{
    public static ВидиПодатків_PointerTablePartCell New() => NewWithProperties([]);
    ...
    {
        Pointer = new ВидиПодатків_Pointer(p ?? new UniqueID());
