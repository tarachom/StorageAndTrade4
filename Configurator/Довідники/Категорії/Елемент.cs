...
partial class Категорії_Елемент : DirectoryFormElement
{
    ...
    partial void Initialize()
    {
        ...
        {
            //Заповнення списку
            foreach (var field in ПсевдонімиПерелічення.МетодиСписанняПартій_List())
    ...
    protected override void GetValue()
    {
        ...
        Елемент.МетодСписання = ПсевдонімиПерелічення.МетодиСписанняПартій_FindByName(МетодСписання.ActiveId);
