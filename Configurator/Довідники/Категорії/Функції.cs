...
static class Категорії_Функції
{
    public static List<Where> Відбори(string searchText)
    {
        ...
        [
            ...
            //Код
            new Where(Категорії_Const.Код, Comparison.LIKE, searchText) { FuncToField = "LOWER" },
                    
            //Назва
            new Where(Comparison.OR, Категорії_Const.Назва, Comparison.LIKE, searchText) { FuncToField = "LOWER" },
    ...
    {
        Категорії_Елемент page = Категорії_Елемент.New();
        ...
        Action<UniqueID>? сallBack_OnSelectPointer = null)
    {
        ...
        Program.BasicForm?.NotebookFunc.CreatePage(Категорії_Const.FULLNAME, page);
        await page.SetValue();
    }

    public static async ValueTask SetDeletionLabel(UniqueID uniqueID)
    {
        Категорії_Pointer Вказівник = new(uniqueID);
