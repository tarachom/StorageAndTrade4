...
/*     
        Бланки_PointerTablePartCell.cs
...
[GObject.Subclass<PointerTablePartCell>("PointerTablePartCell_gW2dNxXvT0y79HHeOXlkng")]
public partial class Бланки_PointerTablePartCell : PointerTablePartCell
{
    public static Бланки_PointerTablePartCell New() => NewWithProperties([]);
    ...
    {
        Pointer = new Бланки_Pointer(p ?? new UniqueID());
