...
[GObject.Subclass<DirectoryFormJournalFullTree>("List_kZwDMGHCkuZC3fhPaPVQ")]
partial class Статті_Список : DirectoryFormJournalFullTree
{
    ...
    public static Статті_Список New()
    {
        Статті_Список list = NewWithProperties([]);
