...
/*     
        Статті_PointerTablePartCell.cs
...
[GObject.Subclass<PointerTablePartCell>("PointerTablePartCell_aFb0GSfE6UqQAGombziVA")]
public partial class Статті_PointerTablePartCell : PointerTablePartCell
{
    public static Статті_PointerTablePartCell New() => NewWithProperties([]);
    ...
    {
        Pointer = new Статті_Pointer(p ?? new UniqueID());
