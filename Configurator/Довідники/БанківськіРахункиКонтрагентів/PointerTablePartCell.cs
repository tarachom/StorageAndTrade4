...
/*     
        БанківськіРахункиКонтрагентів_PointerTablePartCell.cs
...
[GObject.Subclass<PointerTablePartCell>("PointerTablePartCell_Cc1r7AwraUS3wz0YR7plJA")]
public partial class БанківськіРахункиКонтрагентів_PointerTablePartCell : PointerTablePartCell
{
    ...
    {
        Pointer = new БанківськіРахункиКонтрагентів_Pointer(p ?? new UniqueID());
    ...
    protected override async void Select(Button button, EventArgs args)
    {
        ...
        БанківськіРахункиКонтрагентів_ШвидкийВибір page = БанківськіРахункиКонтрагентів_ШвидкийВибір.New();
