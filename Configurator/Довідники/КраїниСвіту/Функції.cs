...
static class КраїниСвіту_Функції
{
    public static List<Where> Відбори(string searchText)
    {
        ...
        [
            ...
            //Код
            new Where(КраїниСвіту_Const.Код, Comparison.LIKE, searchText) { FuncToField = "TO_CHAR", FuncToField_Param1 = "''" },
                    
            //Назва
            new Where(Comparison.OR, КраїниСвіту_Const.Назва, Comparison.LIKE, searchText) { FuncToField = "TO_CHAR", FuncToField_Param1 = "''" },
    ...
    {
        КраїниСвіту_Елемент page = КраїниСвіту_Елемент.New();
    ...
    public static async ValueTask OpenPageList(UniqueID? uniqueID = null, ConfigurationDirectories.HierarchicalContentType? allowedContentSelection = null, UniqueID? openFolder = null,
        Action<UniqueID>? сallBack_OnSelectPointer = null)
    {
        КраїниСвіту_Список page = КраїниСвіту_Список.New();
        ...
        Program.BasicForm?.NotebookFunc.CreatePage(КраїниСвіту_Const.FULLNAME, page);
        await page.SetValue();
    }

    public static async ValueTask SetDeletionLabel(UniqueID uniqueID)
    {
        КраїниСвіту_Pointer Вказівник = new(uniqueID);
