...
[GObject.Subclass<DirectoryFormJournalFull>("List_hKNEZ8sWkSWMZs54i0apA")]
partial class ОсновніЗасоби_Список : DirectoryFormJournalFull
{
    ...
    public static ОсновніЗасоби_Список New()
    {
        ОсновніЗасоби_Список list = NewWithProperties([]);
