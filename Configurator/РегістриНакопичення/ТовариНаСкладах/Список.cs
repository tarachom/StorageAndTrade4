...
[GObject.Subclass<RegisterAccumulationFormJournalBase>("List_MHpdlkwdUyJcTNfQFo2XQ")]
public partial class ТовариНаСкладах_Список : RegisterAccumulationFormJournalBase
{
    ...
    public static ТовариНаСкладах_Список New()
    {
        ТовариНаСкладах_Список list = NewWithProperties([]);
