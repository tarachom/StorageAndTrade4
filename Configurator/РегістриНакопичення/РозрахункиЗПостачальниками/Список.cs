...
public class РозрахункиЗПостачальниками_Список : RegisterAccumulationFormJournalBase
{
    public РозрахункиЗПостачальниками_Список() : base(Program.BasicForm?.NotebookFunc)
    {
