...
public class ЗамовленняПостачальникам_Список : RegisterAccumulationFormJournalBase
{
    public ЗамовленняПостачальникам_Список() : base(Program.BasicForm?.NotebookFunc)
    {
