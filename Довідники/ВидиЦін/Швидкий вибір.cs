...
using ТабличнийСписок = GeneratedCode.Довідники.ТабличніСписки.ВидиЦін_ЗаписиШвидкийВибір;
using Функції = StorageAndTrade.ВидиЦін_Функції;

namespace StorageAndTrade;

[GObject.Subclass<DirectoryFormJournalSmall>("SmallList_ETd5FnOPTEirqox7zsefGQ")]
partial class ВидиЦін_ШвидкийВибір : DirectoryFormJournalSmall
{
    ...
    public static ВидиЦін_ШвидкийВибір New()
    {
        ВидиЦін_ШвидкийВибір list = NewWithProperties([]);
