...
static class СтруктураПідприємства_Функції
{
    ...
    {
        СтруктураПідприємства_Елемент page = СтруктураПідприємства_Елемент.New();
    ...
    {
        СтруктураПідприємства_Object Обєкт = new();
        if (await Обєкт.Read(uniqueID))
        {
            СтруктураПідприємства_Object Новий = await Обєкт.Copy(true);
            await Новий.Save();
