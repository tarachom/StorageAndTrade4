...
using ТабличнийСписок = GeneratedCode.Довідники.ТабличніСписки.Склади_ЗаписиШвидкийВибір;
using Функції = StorageAndTrade.Склади_Функції;

namespace StorageAndTrade;

[GObject.Subclass<DirectoryFormJournalSmall>("SmallList_BMarfazE4keht7Ii0PRQcA")]
partial class Склади_ШвидкийВибір : DirectoryFormJournalSmall
{
    ...
    public static Склади_ШвидкийВибір New()
    {
        Склади_ШвидкийВибір list = NewWithProperties([]);
