...
static class КасиККМ_Функції
{
    public static List<Where> Відбори(string searchText)
    {
        ...
        [
            ...
            //Назва
            new Where(КасиККМ_Const.Назва, Comparison.LIKE, searchText) { FuncToField = "LOWER" },
    ...
    {
        КасиККМ_Елемент page = КасиККМ_Елемент.New();
    ...
    public static async Task OpenPageList(UniqueID? uniqueID = null, ConfigurationDirectories.HierarchicalContentType? allowedContentSelection = null, UniqueID? openFolder = null,
        Action<UniqueID>? сallBack_OnSelectPointer = null)
    {
        КасиККМ_Список page = КасиККМ_Список.New();
        ...
        Program.BasicForm?.NotebookFunc.CreatePage(КасиККМ_Const.FULLNAME, page);
        await page.SetValue();
    }
