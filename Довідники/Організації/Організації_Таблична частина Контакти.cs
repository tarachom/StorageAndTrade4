...
[GObject.Subclass<DirectoryFormTablePart>("TablePart_N3hDZPchm0mkjjU9O1TKtQ")]
partial class Організації_ТабличнаЧастина_Контакти : DirectoryFormTablePart
{
    #region Data
    
    [GObject.Subclass<GObject.Object>("ItemRow_N3hDZPchm0mkjjU9O1TKtQ")]
    ...
    public Організації_Object? ЕлементВласник { get; set; }
    ...
    public static Організації_ТабличнаЧастина_Контакти New()
    {
        Організації_ТабличнаЧастина_Контакти tablePart = NewWithProperties([]);
