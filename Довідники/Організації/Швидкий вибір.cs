...
using ТабличнийСписок = GeneratedCode.Довідники.ТабличніСписки.Організації_Записи;
using Функції = StorageAndTrade.Організації_Функції;

namespace StorageAndTrade;

[GObject.Subclass<DirectoryFormJournalSmall>("SmallList_ljZENQQaESx0zXk0qxInw")]
partial class Організації_ШвидкийВибір : DirectoryFormJournalSmall
{
    
    
    partial void Initialize()
    {
        TypeName = Організації_Const.POINTER;
        KeyForSetting = ".Small";
    ...
    public static Організації_ШвидкийВибір New()
    {
        Організації_ШвидкийВибір list = NewWithProperties([]);
