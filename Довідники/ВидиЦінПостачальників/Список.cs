...
[GObject.Subclass<DirectoryFormJournalFull>("List_s3Ya82W9IkurW5Wk0U7Qg")]
partial class ВидиЦінПостачальників_Список : DirectoryFormJournalFull
{
    ...
    public static ВидиЦінПостачальників_Список New()
    {
        ВидиЦінПостачальників_Список list = NewWithProperties([]);
