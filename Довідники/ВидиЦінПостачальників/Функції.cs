...
static class ВидиЦінПостачальників_Функції
{
    ...
    {
        ВидиЦінПостачальників_Елемент page = ВидиЦінПостачальників_Елемент.New();
    ...
    public static async Task OpenPageList(UniqueID? uniqueID = null, ConfigurationDirectories.HierarchicalContentType? allowedContentSelection = null, UniqueID? openFolder = null,
        Action<UniqueID>? сallBack_OnSelectPointer = null)
    {
        ВидиЦінПостачальників_Список page = ВидиЦінПостачальників_Список.New();
        ...
        Program.BasicForm?.NotebookFunc.CreatePage(ВидиЦінПостачальників_Const.FULLNAME, page);
        await page.SetValue();
    }

    public static async Task SetDeletionLabel(UniqueID uniqueID)
    {
        ВидиЦінПостачальників_Pointer Вказівник = new(uniqueID);
