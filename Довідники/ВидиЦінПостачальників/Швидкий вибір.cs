...
using ТабличнийСписок = GeneratedCode.Довідники.ТабличніСписки.ВидиЦінПостачальників_Записи;
using Функції = StorageAndTrade.ВидиЦінПостачальників_Функції;

namespace StorageAndTrade;

[GObject.Subclass<DirectoryFormJournalSmall>("SmallList_0lyQOikIRkmXsggPWuCBQ")]
partial class ВидиЦінПостачальників_ШвидкийВибір : DirectoryFormJournalSmall
{
    ...
    public static ВидиЦінПостачальників_ШвидкийВибір New()
    {
        ВидиЦінПостачальників_ШвидкийВибір list = NewWithProperties([]);
