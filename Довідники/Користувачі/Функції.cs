...
static class Користувачі_Функції
{
    public static List<Where> Відбори(string searchText)
    {
        ...
        [
            ...
            //Код
            new Where(Користувачі_Const.Код, Comparison.LIKE, searchText) { FuncToField = "TO_CHAR", FuncToField_Param1 = "''" },
                    
            //Назва
            new Where(Comparison.OR, Користувачі_Const.Назва, Comparison.LIKE, searchText) { FuncToField = "TO_CHAR", FuncToField_Param1 = "''" },
    ...
    {
        Користувачі_Елемент page = Користувачі_Елемент.New();
    ...
    public static async Task OpenPageList(UniqueID? uniqueID = null, ConfigurationDirectories.HierarchicalContentType? allowedContentSelection = null, UniqueID? openFolder = null,
        Action<UniqueID>? сallBack_OnSelectPointer = null)
    {
        Користувачі_Список page = Користувачі_Список.New();
        ...
        Program.BasicForm?.NotebookFunc.CreatePage(Користувачі_Const.FULLNAME, page);
        await page.SetValue();
    }

    public static async Task SetDeletionLabel(UniqueID uniqueID)
    {
        Користувачі_Pointer Вказівник = new(uniqueID);
