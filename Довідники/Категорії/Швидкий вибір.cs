...
using ТабличнийСписок = GeneratedCode.Довідники.ТабличніСписки.Категорії_Записи;
using Функції = StorageAndTrade.Категорії_Функції;

namespace StorageAndTrade;

[GObject.Subclass<DirectoryFormJournalSmallTree>("SmallList_eENBOEKckG08PQbyPsdKw")]
partial class Категорії_ШвидкийВибір : DirectoryFormJournalSmallTree
{
    partial void Initialize()
    {
        TypeName = Категорії_Const.POINTER;
        KeyForSetting = ".Small";
        ТабличнийСписок.AddColumn(this);
        SetPagesSettings(50);
    }

    public static Категорії_ШвидкийВибір New()
    {
        Категорії_ШвидкийВибір list = NewWithProperties([]);
