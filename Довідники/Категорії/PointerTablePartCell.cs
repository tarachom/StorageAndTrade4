...
/*     
        Категорії_PointerTablePartCell.cs
...
[GObject.Subclass<PointerTablePartCell>("PointerTablePartCell_HqaHidHDI0SlaeU3RbnoYw")]
public partial class Категорії_PointerTablePartCell : PointerTablePartCell
{
    public static Категорії_PointerTablePartCell New() => NewWithProperties([]);
    ...
    {
        Pointer = new Категорії_Pointer(p ?? new UniqueID());
