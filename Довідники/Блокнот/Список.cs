...
[GObject.Subclass<DirectoryFormJournalFull>("List_crtrnnyvo0yMYZpA5lgKSg")]
partial class Блокнот_Список : DirectoryFormJournalFull
{
    ...
    public static Блокнот_Список New()
    {
        Блокнот_Список list = NewWithProperties([]);
