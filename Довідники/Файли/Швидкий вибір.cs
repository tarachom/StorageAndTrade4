...
using ТабличнийСписок = GeneratedCode.Довідники.ТабличніСписки.Файли_ЗаписиШвидкийВибір;
using Функції = StorageAndTrade.Файли_Функції;

namespace StorageAndTrade;

[GObject.Subclass<DirectoryFormJournalSmall>("SmallList_2Jj14jEDRUmMjJMLeSgjZA")]
partial class Файли_ШвидкийВибір : DirectoryFormJournalSmall
{
    ...
    public static Файли_ШвидкийВибір New()
    {
        Файли_ШвидкийВибір list = NewWithProperties([]);
