...
[GObject.Subclass<DirectoryFormJournalSmall>("SmallList_SsCg8U0gEanve3ixt0E8A")]
partial class БанківськіРахункиКонтрагентів_ШвидкийВибір : DirectoryFormJournalSmall
{
    ...
    public static БанківськіРахункиКонтрагентів_ШвидкийВибір New()
    {
        БанківськіРахункиКонтрагентів_ШвидкийВибір list = NewWithProperties([]);
