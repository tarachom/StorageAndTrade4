...
/*     
        МалоцінніПредмети_ШвидкийВибір.cs
        ШвидкийВибір
*/
...
[GObject.Subclass<DirectoryFormJournalSmall>("SmallList_QD2cFRM7qUKcRJBtve6ow")]
partial class МалоцінніПредмети_ШвидкийВибір : DirectoryFormJournalSmall
{
    ...
    public static МалоцінніПредмети_ШвидкийВибір New()
    {
        МалоцінніПредмети_ШвидкийВибір list = NewWithProperties([]);
