...
/*     
        НоменклатураВнутрішня_Папки_ШвидкийВибір.cs
        ШвидкийВибір
*/
...
using ТабличнийСписок = GeneratedCode.Довідники.ТабличніСписки.НоменклатураВнутрішня_Папки_Записи;
using Функції = StorageAndTrade.НоменклатураВнутрішня_Папки_Функції;

namespace StorageAndTrade;

[GObject.Subclass<DirectoryFormJournalSmallTree>("SmallList_Sqjuf3TC0eYhVTtZvPA")]
partial class НоменклатураВнутрішня_Папки_ШвидкийВибір : DirectoryFormJournalSmallTree
{
    
    
    partial void Initialize()
    {
        TypeName = НоменклатураВнутрішня_Папки_Const.POINTER;
        KeyForSetting = ".Small";
    ...
    public static НоменклатураВнутрішня_Папки_ШвидкийВибір New()
    {
        НоменклатураВнутрішня_Папки_ШвидкийВибір list = NewWithProperties([]);
