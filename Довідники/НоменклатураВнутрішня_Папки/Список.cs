...
/*      
        НоменклатураВнутрішня_Папки.cs
        Список
*/
...
[GObject.Subclass<DirectoryFormJournalFullTree>("List_3Kr8RUdRWEeQBBm23C4Mmg")]
partial class НоменклатураВнутрішня_Папки_Список : DirectoryFormJournalFullTree
{
    ...
    public static НоменклатураВнутрішня_Папки_Список New()
    {
        НоменклатураВнутрішня_Папки_Список list = NewWithProperties([]);
