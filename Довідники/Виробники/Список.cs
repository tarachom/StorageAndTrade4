...
[GObject.Subclass<DirectoryFormJournalFull>("List_3NZRO8ceZ0OCkqt5Vm2K0g")]
partial class Виробники_Список : DirectoryFormJournalFull
{
    ...
    public static Виробники_Список New()
    {
        Виробники_Список list = NewWithProperties([]);
