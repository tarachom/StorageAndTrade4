...
using ТабличнийСписок = GeneratedCode.Довідники.ТабличніСписки.Виробники_Записи;
using Функції = StorageAndTrade.Виробники_Функції;

namespace StorageAndTrade;

[GObject.Subclass<DirectoryFormJournalSmall>("SmallList_2wfJ8NyaMkqFOHmULjJx8Q")]
partial class Виробники_ШвидкийВибір : DirectoryFormJournalSmall
{
    ...
    public static Виробники_ШвидкийВибір New()
    {
        Виробники_ШвидкийВибір list = NewWithProperties([]);
