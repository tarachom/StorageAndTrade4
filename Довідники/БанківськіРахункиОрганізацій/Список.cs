...
[GObject.Subclass<DirectoryFormJournalFull>("List_JWLVWdltjkiSyLOpJFVXA")]
partial class БанківськіРахункиОрганізацій_Список : DirectoryFormJournalFull
{
    ...
    public static БанківськіРахункиОрганізацій_Список New()
    {
        БанківськіРахункиОрганізацій_Список list = NewWithProperties([]);
