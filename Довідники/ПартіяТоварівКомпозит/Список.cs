...
using ТабличнийСписок = GeneratedCode.Довідники.ТабличніСписки.ПартіяТоварівКомпозит_Записи;
using Функції = StorageAndTrade.ПартіяТоварівКомпозит_Функції;

namespace StorageAndTrade;

[GObject.Subclass<DirectoryFormJournalFull>("List_O3ghyHLO02zGRuiYfIA")]
partial class ПартіяТоварівКомпозит_Список : DirectoryFormJournalFull
{
    ...
    public static ПартіяТоварівКомпозит_Список New()
    {
        ПартіяТоварівКомпозит_Список list = NewWithProperties([]);
