...
partial class ПартіяТоварівКомпозит_Елемент : DirectoryFormElement
{
    ...
    DropDownControl ТипДокументу = DropDownControl.New();
    ...
    partial void Initialize()
    {
        ...
        // ТипДокументу:
        ТипДокументу.Fill(ПсевдонімиПерелічення.ТипДокументуПартіяТоварівКомпозит_Dict());
    ...
    public override async Task AssignValue()
    {
        ...
        ТипДокументу.Value = Елемент.ТипДокументу.ToString();
    ...
    protected override void GetValue()
    {
        ...
        Елемент.ТипДокументу = ПсевдонімиПерелічення.ТипДокументуПартіяТоварівКомпозит_FindByName(ТипДокументу.Value);
