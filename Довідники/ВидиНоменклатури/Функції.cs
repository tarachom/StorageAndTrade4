...
static class ВидиНоменклатури_Функції
{
    public static List<Where> Відбори(string searchText)
    {
        ...
        [
            ...
            //Код
            new Where(ВидиНоменклатури_Const.Код, Comparison.LIKE, searchText) { FuncToField = "TO_CHAR", FuncToField_Param1 = "''" },
                    
            //Назва
            new Where(Comparison.OR, ВидиНоменклатури_Const.Назва, Comparison.LIKE, searchText) { FuncToField = "TO_CHAR", FuncToField_Param1 = "''" },
    ...
    {
        ВидиНоменклатури_Елемент page = ВидиНоменклатури_Елемент.New();
    ...
    public static async ValueTask OpenPageList(UniqueID? uniqueID = null, ConfigurationDirectories.HierarchicalContentType? allowedContentSelection = null, UniqueID? openFolder = null,
        Action<UniqueID>? сallBack_OnSelectPointer = null)
    {
        ВидиНоменклатури_Список page = ВидиНоменклатури_Список.New();
        ...
        Program.BasicForm?.NotebookFunc.CreatePage(ВидиНоменклатури_Const.FULLNAME, page);
        await page.SetValue();
    }

    public static async ValueTask SetDeletionLabel(UniqueID uniqueID)
    {
        ВидиНоменклатури_Pointer Вказівник = new(uniqueID);
