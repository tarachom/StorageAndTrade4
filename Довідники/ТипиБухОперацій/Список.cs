...
[GObject.Subclass<DirectoryFormJournalFull>("List_PL1ICCaHI0C2zlue9fBwIw")]
partial class ТипиБухОперацій_Список : DirectoryFormJournalFull
{
    ...
    public static ТипиБухОперацій_Список New()
    {
        ТипиБухОперацій_Список list = NewWithProperties([]);
